...
C  ISTR: NUMBER OF STRATUM
     ...
     .              IRUSR,IPUSR,ITUSR,IAUSR,IBUSR,
     .              TIWL,TEWL,DIWL,VXWL,VYWL,VZWL,EFWL,SHWL,WEISPZ)
C  FIND BIRTH POINT COORDINATES. SUBSTRATUM ISR IF STRATUM ISTRA
C  HAS ALREADY BEEN IDENTIFIED. ISTRA (IF NEEDED) IS IN MODULE COMPRT.
...
C  HERE COMES THE PROBLEM SPECIFIC DEFINITION OF BIRTH POINT SAMPLING
