...
surface", ($ILIIN\ge 4$) then the default reflection model (i.e.\ $Fe-Target$, recycling coefficient = one, etc\dots) is activated for this
surface.
...
(surface sticking, pumping, etc\dots)
