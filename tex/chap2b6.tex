...
\begin{description}
\item[ERMIN] For incident particle energies below
...
\item[RECYCS] The meaning of this flag for the
...
Default: RECYCS = 1.
\end{description}
\item[RECYCC] The meaning of this flag for the
