...
Default: EWALL = +0.0388 ($\simeq$ TW = 0.026 \si{\electronvolt}  $\simeq$  300 \si{\kelvin})
...
for particles with temperature $T$ [\si{\kelvin}] and mass $m$ [AMU] is related to the sticking fraction $p_a = 1 -RECYCT$ by
