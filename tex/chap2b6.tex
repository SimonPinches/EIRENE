...
\textsl{*** 6A. Data for General Reflection Models}
\begin{verbatim}
 NLTRIM
...
\begin{list}{ }{}
\item[\textbf{NLTRIM }] TRIM database is used, if ``Database
...
first NHD6 files are read from FT21. \item[\textbf{``Path Card"
...
reflection data files. \item[\textbf{A\_on\_B }] Name of a
...
\textsl{*** 6B. Data for Local Reflection and Sputtering Models}
...
\item[\textbf{RECYCS }] The meaning of this flag for the
...
Default: RECYCS = 1.
\end{list}
\item[\textbf{RECYCC }] The meaning of this flag for the
