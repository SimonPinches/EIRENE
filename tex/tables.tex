...
\begin{tabular} {|r|l|l|l|l|c|} \hline
 ...
 -1 & TEIN & Plasma Temperature, Electrons & 1 & $eV$ & /  \\ \hline
 -2 & TIIN & Plasma Temperature, Bulk Ions & NPLSTI & $eV$ & /  \\ \hline
...
\endhead
 ...
 \\ \hline
 5 & EDENA & Energy density, Atoms & NATM       & eV*\si{\per\cubic\centi\metre} & TE
 \\ \hline
 6 & EDENM & Energy density, Molecules & NMOL   & eV*\si{\per\cubic\centi\metre} & TE
 \\ \hline
 7 & EDENI & Energy density, Test Ions & NION   & eV*\si{\per\cubic\centi\metre} & TE
 \\ \hline
 8 & EDENPH & Energy density, Photons & NPHOT   & eV*\si{\per\cubic\centi\metre} & TE
 \\ \hline
 9 & PAEL & Particle Source (Electrons) from atom-plasma coll.
   & 1 & amp* \si{\per\cubic\centi\metre} & TPS  \\ \hline
 10 & PAAT & Particle Source (Atoms) from atom-plasma coll.
   & NATM & amp*\si{\per\cubic\centi\metre} & TPS \\ \hline
 11 & PAML & Particle Source (Molecules) from atom-plasma coll.
   & NMOL & amp*\si{\per\cubic\centi\metre} & TPS \\  \hline
 12 & PAIO & Particle Source (Test Ions) from atom-plasma coll.
    & NION & amp*\si{\per\cubic\centi\metre} & TPS  \\  \hline
 13 & PAPHT & Particle Source (Photons) from atom-plasma coll.
    & NPHOT & amp*\si{\per\cubic\centi\metre} & TPS  \\  \hline
 14 & PAPL & Particle Source (Bulk Ions) from atom-plasma coll.
    & NPLS & amp*\si{\per\cubic\centi\metre} & TPS  \\  \hline
...
\pagebreak
 ...
 63 & PGENA & Generation limit, Atoms & NATM & amp*\si{\per\cubic\centi\metre} & CG
 \\ \hline
 64 & PGENM & Generation limit, Molecules & NMOL & amp*\si{\per\cubic\centi\metre} & CG
 \\
\hline
\pagebreak
 65 & PGENI & Generation limit, Test ions & NION & amp*\si{\per\cubic\centi\metre} & CG
 \\ \hline
 66 & PGENPH & Generation limit, Photons & NPHOT & amp*\si{\per\cubic\centi\metre} & CG
 \\ \hline
 67 & EGENA & dito, Energy flux, Atoms & NATM & watt*\si{\per\cubic\centi\metre} & CG
 \\ \hline
 68 & EGENM & dito, Energy flux, Molecules & NMOL & watt*\si{\per\cubic\centi\metre} & CG
 \\ \hline
 69 & EGENI & dito, Energy flux, Test ions & NION & watt*\si{\per\cubic\centi\metre} & CG
 \\ \hline
 70 & EGENPH & dito, Energy flux, Photons & NPHOT & watt*\si{\per\cubic\centi\metre} & CG
 \\ \hline
...
amp*\si{\per\cubic\centi\metre} & C1
\\ \hline
...
amp*\si{\per\cubic\centi\metre} & C1
\\ \hline
80 & EPAT & primary energy sources rate, Atoms & 1 & watt*\si{\per\cubic\centi\metre}
& C1
\\ \hline
81 & EPML & primary energy sources rate, Molecules & 1 &
watt*\si{\per\cubic\centi\metre} & C1
\\ \hline
...
NPLS & amp*\si{\gram\centi\metre\per\second\per\cubic\centi\metre} & TPM
\\ \hline
98 & MMPL & parallel momentum source rate, (Bulk Ions) & NPLS &
amp*\si{\gram\centi\metre\per\second\per\cubic\centi\metre} & TPM
\\ \hline
...
(per cell or per $cm^3$), when particles are removed from the fully kinetic tracing, due to e.g. transition into a
...
\begin{tabular} {|r|l|l|l|l|} \hline
 ...
 -1 & TEIN & Plasma Temperature, Electrons & 1 & $eV$   \\ \hline
 -2 & TIIN & Plasma Temperature, Bulk Ions & NPLS & $eV$   \\ \hline
 -3 & DEIN$^*$ & Plasma Density, Electrons & 1 & \si{\per\cubic\centi\metre}   \\ \hline
 -4 & DIIN & Plasma Density, Bulk Ions & NPLS & \si{\per\cubic\centi\metre}  \\ \hline
 -5 & VXIN & Plasma Drift Velocity, x-component, Bulk Ions&NPLS  & cm/sec  \\ \hline
...
\begin{tabular}{|r|l|l|l|l|c|} \hline
 ...
 42 & ALGV & Algebraic expression in volume averaged tallies
    & NALV & Input & ALG        \\  \hline
 43 & PGENA & Generation limit, Atoms & NATM & amp*\si{\per\cubic\centi\metre} & T1
 \\ \hline
 44 & PGENM & Generation limit, Molecules & NMOL & amp*\si{\per\cubic\centi\metre} & T1
 \\ \hline
 45 & PGENI & Generation limit, Test ions & NION & amp*\si{\per\cubic\centi\metre} & T1
 \\ \hline
 46 & EGENA & dito, Energy flux, Atoms & NATM & watt*\si{\per\cubic\centi\metre} & T1
 \\ \hline
 47 & EGENM & dito, Energy flux, Molecules & NMOL
& watt*\si{\per\cubic\centi\metre} & T1
 \\ \hline
 48 & EGENI & dito, Energy flux, Test ions & NION & watt*\si{\per\cubic\centi\metre} & T1
 \\ \hline
