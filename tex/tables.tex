...
the incident test particle) involved in a collision process: \ac{Pht}, 
\ac{Ats}, \ac{Mls}, \ac{TI}. This
...
have to be implemented in the \ordinalnum{3} party (user) or the problem specific
...
test particles, resolved by type of test particle (name of tally) and by species of bulk particle (\ordinalnum{1} index in array).
\end{description}
...
the type of the incident particle: \acf{Pht}, \acf{Ats},
\acf{Mls}, \acf{TI} or \ac{BI}. This
...
PRF\dots\ are fluxes reflected or emitted due to incident particle fluxes, of type [A], SPT[A][BC] are sputtered fluxes (additional
...
\begin{table}[ht]
\caption{\textbf{Input Tallies for Background, Input, Module: COMUSR}}
\label{tab1} 
\begin{footnotesize}
...
derived input tallies are set via subroutine PLASMA\_DERIV.f.
...
\item  Magnetic field input is needed only for photon transport with Zeeman split line shapes, or
...
\caption{\textbf{Volume Averaged Tallies, Output, Module: CESTIM}}
\label{tab2}
\\
\hline
\textbf{No} & \textbf{Name} & \textbf{Macroscopic quantity}
...
as well as by the corresponding ``\ordinalnum{1} dimension" (species)  NATM, NMOL, NION, NPHOT, NPLS and ``1" (one) for electrons.
...
is determined by the magnetic field unit vector (input tallies BXIN, \dots).

\bigskip
\textbf{Estimators} EIRENE resorts, by default, to track-length
...
runs.)
\begin{description}
\item[TD]  Track-length, particle density. $g_t= 1/v$, $v=VEL$ the
...
a cell.
\item[TE]  Track-length, (kinetic) energy density. In case of photon tallies, the energy used is $E0 = h\nu$
\item[TPS] Track-length, particle source rate
\item[TPM] Track-length, parallel (to B-field) momentum source/sink. The (vectorial) momentum exchange rate
...
\endhead
 1 & POTAT &Particle Flux, incident, Atoms&NATM
    & \si{\ampere} & T/C  \\ \hline
 2 & PRFAAT &Particle Flux, emitted, \ac{Ats}$\Rightarrow$Atoms&NATM
    & \si{\ampere} & T/C  \\  \hline
 3 & PRFMAT &Particle Flux, emitted, \ac{Mls}$\Rightarrow$Atoms&NATM
    & \si{\ampere} & T/C  \\  \hline
 4 & PRFIAT &Particle Flux, emitted, \ac{TI}$\Rightarrow$Atoms&NATM
    & \si{\ampere} & T/C  \\  \hline
 5 & PRFPHAT &Particle Flux, emitted, \ac{Pht}$\Rightarrow$Atoms&NATM
    & \si{\ampere} & T/C  \\  \hline
 6 & PRFPAT &Particle Flux, emitted, \ac{BI}$\Rightarrow$Atoms&NATM
    & \si{\ampere} & T/C  \\  \hline
 7 & POTML &Particle Flux, incident, Molecules&NMOL
    & \si{\ampere} & T/C  \\  \hline
 8 & PRFAML &Particle Flux, emitted, \ac{Ats}$\Rightarrow$Molecules&NMOL
    & \si{\ampere} & T/C  \\   \hline
 9 & PRFMML &Particle Flux, emitted, \ac{Mls}$\Rightarrow$Molecules&NMOL
    & \si{\ampere} & T/C  \\   \hline
 10 & PRFIML &Particle Flux, emitted, \ac{TI}$\Rightarrow$Molecules&NMOL
    & \si{\ampere} & T/C  \\   \hline
 11 & PRFPHML &Particle Flux, emitted, \ac{Pht}$\Rightarrow$Molecules&NMOL
    & \si{\ampere} & T/C  \\   \hline
 12 & PRFPML &Particle Flux, emitted, \ac{BI}$\Rightarrow$Molecules&NMOL
    & \si{\ampere} & T/C  \\   \hline
 13 & POTIO &Particle Flux, incident, Test Ions&NION
    & \si{\ampere} & T/C  \\    \hline
 14 & PRFAIO &Particle Flux, emitted, \ac{Ats}$\Rightarrow$Test Ions&NION
    & \si{\ampere} & T/C  \\    \hline
 15 & PRFMIO &Particle Flux, emitted, \ac{Mls}$\Rightarrow$Test Ions&NION
    & \si{\ampere} & T/C  \\    \hline
 16 & PRFIIO &Particle Flux, emitted, \ac{TI}$\Rightarrow$Test Ions&NION
    & \si{\ampere} & T/C  \\    \hline
 17 & PRFPHIO &Particle Flux, emitted, \ac{Pht}$\Rightarrow$Test Ions&NION
    & \si{\ampere} & T/C  \\    \hline
 18 & PRFPIO &Particle Flux, emitted, \ac{BI}$\Rightarrow$Test Ions&NION
    & \si{\ampere} & T/C  \\    \hline
 19 & POTPHT &Particle Flux, incident, Photons&NPHOT
    & \si{\ampere} & T/C  \\    \hline
 20 & PRFAPHT &Particle Flux, emitted, \ac{Ats}$\Rightarrow$Photons&NPHOT
    & \si{\ampere} & T/C  \\    \hline
 21 & PRFMPHT &Particle Flux, emitted, \ac{Mls}$\Rightarrow$Photons&NPHOT
    & \si{\ampere} & T/C  \\    \hline
 22 & PRFIPHT &Particle Flux, emitted, \ac{TI}$\Rightarrow$Photons&NPHOT
    & \si{\ampere} & T/C  \\    \hline
 23 & PRFPHPHT &Particle Flux, emitted, \ac{Pht}$\Rightarrow$Photons&NPHOT
    & \si{\ampere} & T/C  \\    \hline
 24 & PRFPPHT &Particle Flux, emitted, \ac{BI}$\Rightarrow$Photons&NPHOT
    & \si{\ampere} & T/C  \\    \hline
...
\pagebreak
 26 & EOTAT &Energy Flux, incident, Atoms&NATM
    & \si{\watt} & T/C  \\   \hline
 27 & ERFAAT &Energy Flux, emitted, \ac{Ats}$\Rightarrow$Atoms&NATM
    & \si{\watt} & T/C  \\   \hline
 28 & ERFMAT &Energy Flux, emitted, \ac{Mls}$\Rightarrow$Atoms&NATM
    & \si{\watt} & T/C  \\   \hline
 29 & ERFIAT &Energy Flux, emitted, \ac{TI}$\Rightarrow$Atoms&NATM
    & \si{\watt} & T/C  \\   \hline
 30 & ERFPHAT &Energy Flux, emitted, \ac{Pht}$\Rightarrow$Atoms&NATM
    & \si{\watt} & T/C  \\   \hline
 31 & ERFPAT &Energy Flux, emitted, \ac{BI}$\Rightarrow$Atoms&NATM
    & \si{\watt} & T/C  \\   \hline
 32 & EOTML &Energy Flux, incident, Molecules&NMOL
    & \si{\watt} & T/C  \\    \hline
 33 & ERFAML &Energy Flux, emitted, \ac{Ats}$\Rightarrow$Molecules&NMOL
    & \si{\watt} & T/C   \\   \hline
 34 & ERFMML &Energy Flux, emitted, \ac{Mls}$\Rightarrow$Molecules&NMOL
    & \si{\watt} & T/C   \\   \hline
 35 & ERFIML &Energy Flux, emitted, \ac{TI}$\Rightarrow$Molecules&NMOL
    & \si{\watt} & T/C   \\   \hline
 36 & ERFPHML &Energy Flux, emitted, \ac{Pht}$\Rightarrow$Molecules&NMOL
    & \si{\watt} & T/C   \\   \hline
 37 & ERFPML &Energy Flux, emitted, \ac{BI}$\Rightarrow$Molecules&NMOL
    & \si{\watt} & T/C   \\   \hline
 38 & EOTIO &Energy Flux, incident, Test Ions&NION
    & \si{\watt} & T/C   \\   \hline
 39 & ERFAIO & Energy Flux, emitted, \ac{Ats}$\Rightarrow$Test Ions & NION
    & \si{\watt} & T/C   \\   \hline
 40 & ERFMIO & Energy Flux, emitted, \ac{Mls}$\Rightarrow$Test Ions & NION
    & \si{\watt} & T/C   \\   \hline
 41 & ERFIIO & Energy Flux, emitted, \ac{TI}$\Rightarrow$Test Ions & NION
    & \si{\watt} & T/C   \\   \hline
 42 & ERFPHIO & Energy Flux, emitted, \ac{Pht}$\Rightarrow$Test Ions & NION
    & \si{\watt} & T/C   \\   \hline
 43 & ERFPIO & Energy Flux, emitted, \ac{BI}$\Rightarrow$Test Ions & NION
    & \si{\watt} & T/C   \\   \hline
 44 & EOTPHT &Energy Flux, incident, Photons&NPHOT
    & \si{\watt} & T/C   \\   \hline
 45 & ERFAPHT & Energy Flux, emitted, \ac{Ats}$\Rightarrow$Photons & NPHOT
    & \si{\watt} & T/C   \\   \hline
 46 & ERFMPHT & Energy Flux, emitted, \ac{Mls}$\Rightarrow$Photons & NPHOT
    & \si{\watt} & T/C   \\   \hline
 47 & ERFIPHT & Energy Flux, emitted, \ac{TI}$\Rightarrow$Photons & NPHOT
    & \si{\watt} & T/C   \\   \hline
 48 & ERFPHPHT & Energy Flux, emitted, \ac{Pht}$\Rightarrow$Photons & NPHOT
    & \si{\watt} & T/C   \\   \hline
 49 & ERFPPHT & Energy Flux, emitted, \ac{BI}$\Rightarrow$Photons & NPHOT
    & \si{\watt} & T/C   \\   \hline
...
\begin{itemize}
\item[i)] The tallies listed here are two dimensional arrays. The \ordinalnum{2} index I2
is the number of the surface or the surface segment.
 For
I2 = 1, \dots, NLIMI the tallies correspond to the ``Additional Surfaces",
(input block 3B).
\item[ii)] For I2 = NLIM + 1, NLIM + NSTSI * NGITT the data correspond to the
...
\item[iv)] the sputter tallies have been revised at revision SVN 360, Jan 2014, to allow full resolution with respect to both: incident type (for scaling)
...
momentum source rates MAPL, \dots\ and test particle momentum fluxes VXDEN, \dots, VYDEN, \dots, VZDEN.
...
&
 ...
 4 &PRFIAT&Particle Flux, emitted, \ac{TI}$\Rightarrow$Atoms&NATM
    & \si{\ampere} & T/C  \\  \hline
 5 &PRFPAT&Particle Flux, emitted, \ac{BI}$\Rightarrow$Atoms&NATM
    & \si{\ampere} & T/C  \\  \hline
 6 &POTML&Particle Flux, incident, Molecules&NMOL
    & \si{\ampere} & T/C  \\  \hline
 7 &PRFAML&Particle Flux, emitted, \ac{Ats}$\Rightarrow$Molecules&NMOL
    & \si{\ampere} & T/C  \\   \hline
 8 &PRFMML&Particle Flux, emitted, \ac{Mls}$\Rightarrow$Molecules&NMOL
    & \si{\ampere} & T/C  \\   \hline
 9 &PRFIML&Particle Flux, emitted, \ac{TI}$\Rightarrow$Molecules&NMOL
    & \si{\ampere} & T/C  \\   \hline
 10 &PRFPML&Particle Flux, emitted, \ac{BI}$\Rightarrow$Molecules&NMOL
    & \si{\ampere} & T/C  \\   \hline
 11 &POTIO&Particle Flux, incident, Test Ions&NION
    & \si{\ampere} & T/C  \\    \hline
 12 &PRFAIO&Particle Flux, emitted, \ac{Ats}$\Rightarrow$Test Ions&NION
    & \si{\ampere} & T/C  \\    \hline
 13 &PRFMIO&Particle Flux, emitted, \ac{Mls}$\Rightarrow$Test Ions&NION
    & \si{\ampere} & T/C  \\    \hline
 14 &PRFIIO&Particle Flux, emitted, \ac{TI}$\Rightarrow$Test Ions&NION
    & \si{\ampere} & T/C  \\    \hline
 15 &PRFPIO&Particle Flux, emitted, \ac{BI}$\Rightarrow$Test Ions&NION
    & \si{\ampere} & T/C  \\    \hline
 16 &POTPL&Particle Flux, incident, Bulk Ions&NPLS
    & \si{\ampere} & T/C  \\    \hline
 17 &EOTAT&Energy Flux, incident, Atoms&NATM
    & \si{\watt} & T/C  \\   \hline
 18 &ERFAAT&Energy Flux, emitted, \ac{Ats}$\Rightarrow$Atoms&NATM
    & \si{\watt} & T/C  \\   \hline
 19 &ERFMAT&Energy Flux, emitted, \ac{Mls}$\Rightarrow$Atoms&NATM
    & \si{\watt} & T/C  \\   \hline
 20 &ERFIAT&Energy Flux, emitted, \ac{TI}$\Rightarrow$Atoms&NATM
    & \si{\watt} & T/C  \\   \hline
 21 &ERFPAT&Energy Flux, emitted, \ac{BI}$\Rightarrow$Atoms&NATM
    & \si{\watt} & T/C  \\   \hline
 22 &EOTML&Energy Flux, incident, Molecules&NMOL
    & \si{\watt} & T/C  \\    \hline
 23 &ERFAML&Energy Flux, emitted, \ac{Ats}$\Rightarrow$Molecules&NMOL
    & \si{\watt} & T/C   \\   \hline
 24 &ERFMML&Energy Flux, emitted, \ac{Mls}$\Rightarrow$Molecules&NMOL
    & \si{\watt} & T/C   \\   \hline
 25 &ERFIML&Energy Flux, emitted, \ac{TI}$\Rightarrow$Molecules&NMOL
    & \si{\watt} & T/C   \\   \hline
 26 &ERFPML&Energy Flux, emitted, \ac{BI}$\Rightarrow$Molecules&NMOL
    & \si{\watt} & T/C   \\   \hline
 27 &EOTIO&Energy Flux, incident, Test Ions&NION
    & \si{\watt} & T/C   \\   \hline
 28 & ERFAIO & Energy Flux, emitted, \ac{Ats}$\Rightarrow$Test Ions & NION
    & \si{\watt} & T/C   \\   \hline
 29 & ERFMIO & Energy Flux, emitted, \ac{Mls}$\Rightarrow$Test Ions & NION
    & \si{\watt} & T/C   \\   \hline
 30 & ERFIIO & Energy Flux, emitted, \ac{TI}$\Rightarrow$Test Ions & NION
    & \si{\watt} & T/C   \\   \hline
 31 & ERFPIO & Energy Flux, emitted, \ac{BI}$\Rightarrow$Test Ions & NION
    & \si{\watt} & T/C   \\   \hline
...
segment.
 For
I2 = 1, \dots, NLIMI the tallies correspond to the ``Additional
