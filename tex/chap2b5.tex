...
C     only for Eirene version newer than June 2019
\end{lstlisting} 
...
For Eirene versions newer than June 2019 additional input for use with
input tallies is available.

\begin{description}
  \item[``Option-Card''] If Eirene finds a card containing the string 
        ``OPTIONAL'' it assumes that there might be an arbitrary number 
        of input cards describing additional options for input tallies.
  ...
  \item[IOPT] option flag
       \begin{description}
         ...
         \item[$= 2$] prepare for smoothing, interpolate tally ITAL
                      to cornerpoints
