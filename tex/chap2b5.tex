...
are expected.
\begin{description}
\item[CDENMODEL = 'Multiply']
docu to be written
\item[CDENMODEL = 'Constant']
docu to be written
\item[CDENMODEL = 'fort.13']
...
\item[CDENMODEL = 'Saha'] Set parameters from
...
\end{lstlisting}
docu to be written
\item[CDENMODEL = 'Planck']
(only for background photons) to be written
\item[CDENMODEL = 'Corona']
...
\begin{description}
\item[INDPRO] Flag-array for the type of profile. The
