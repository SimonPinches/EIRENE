...
cross section $\sigma (\si{\square\centi\metre})$ as function of energy ELAB (eV),
...
The second argument here controls either the particle energy (in eV) or plasma density (in particles~\si{\per\cubic\centi\metre}/$10^8$) dependence in rate coefficients.
