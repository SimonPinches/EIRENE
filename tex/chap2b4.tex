...
(cm^3/s \cdot AMU \cdot \si{\centi\metre\per\second})$ as function of target temperature
(eV)
\item[{H.6 }]
double parameter fit of target particle velocity weighted rate
coefficient \\
$\langle \sigma v  \cdot  m_p  \cdot  | v_p | \rangle
(cm^3/s \cdot AMU \cdot \si{\centi\metre\per\second})$ as function of projectile energy (eV)
and target temperature (eV)
\item[{H.7 }]
double parameter fit of target particle velocity weighted rate
coefficient \\
$\langle \sigma v  \cdot  m_p  \cdot  | v_p | \rangle
(cm^3/s \cdot AMU\cdot \si{\centi\metre\per\second})$ as function of target density $(cm^3)$
and target temperature (eV)
\item[{H.8 }]
