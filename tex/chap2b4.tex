...
either from external A\&M data files such as \lstinline|FILNAM| = \lstinline|HYDHEL|, = \lstinline|METHAN|, = \lstinline|AMJUEL|, = \lstinline|H2VIBR|,
...
\lstinline|F(I), I=0,5 (REAL)|\\ \lstinline|F(I), I=6,8 (REAL)|\\ are read, in
