...
control further options, such as population escape factors (opacity effects), etc\dots
...
i.e.,
2.1.5a, \dots, 2.1.5e, 2.2.5a, 2.2.5e, etc\dots \\
...
also data formats other than the old polynomial fits read from data files AMJUEL, HYDHEL, etc\dots,
...
LOTH	OTH	Other reaction type data (reduced population coefficients, equilibrium  density ratios, etc\dots)
