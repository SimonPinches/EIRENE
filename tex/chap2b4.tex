...
coefficient \\
$\langle \sigma v  \cdot  m_p  \cdot  | v_p | \rangle
(\si{\cubic\centi\metre\per\second} \cdot AMU \cdot \si{\centi\metre\per\second})$ as function of projectile energy (\si{\electronvolt})
...
(\si{\cubic\centi\metre\per\second} \cdot \si{\electronvolt})$ as function of target temperature (\si{\electronvolt})
\item[{H.9 }]
double parameter fit of target particle energy weighted rate
coefficient \\
$\langle \sigma v  \cdot  m_p /2  \cdot  v_p^2\rangle
(\si{\cubic\centi\metre\per\second} \cdot \si{\electronvolt})$ as function of projectile energy (\si{\electronvolt}) and target
temperature (\si{\electronvolt})
\item[{H.10 }]
double parameter fit of target particle energy weighted rate
coefficient \\
$\langle\sigma~v~\cdot~m_p/2~\cdot~v_p^2\rangle$
$(\si{\cubic\centi\metre\per\second} \cdot \si{\electronvolt})$ as function of target density (\si{\cubic\centi\metre}) and
...
E.g. for reaction $e+CH_4 \rightarrow CH_3 + H + e$, and EP=ESCD=8.0 \si{\electronvolt}, then
the fragment $CH_3$ would receive an extra energy of 0.5 \si{\electronvolt}, and the fragment $H$ would
receive 7.5 \si{\electronvolt},
...
product $\sigma(E_{rel}) v_{rel}$ in the hard wired energy range 0.1 to 1.e4 \si{\electronvolt},
...
per ionization of 13.6 and 24.588 \si{\electronvolt}, respectively.
\medskip
...
The second argument here controls either the particle energy (in \si{\electronvolt}) or plasma density (in particles~\si{\per\cubic\centi\metre}/$10^8$) dependence in rate coefficients.
