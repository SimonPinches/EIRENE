...
DO
\end{verbatim}
\textbf{for ``real particles"}, databases: \texttt{FILNAM = HYDHEL, AMJUEL, METHAN, H2VIBR}
\begin{verbatim}
...
\end{verbatim}
\textbf{for ``real particles"}, database: \texttt{FILNAM = ADAS}
...
\textbf{for ``real particles"}, database: \texttt{FILNAM = CONST}.
...
\vspace{0.3cm}
\textbf{for ``photons"}, database \texttt{FILNAM = PHOTON}
\begin{verbatim}
   IR  PHOTON  H123  REAC
   (format: I3,1X,A6,1X,A4,Axxx)
