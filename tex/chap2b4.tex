...
see card: ``CFILE" DBHANDLE DBFNAME in block 1 (\cref{sec2.1}). For example, REAC = SCD96, then the file \verb+SCD96_h.dat+,
...
More generally: the BGK approximation (\cref{sec1-bgk}) is employed for (bilinear) test-particle  -  test-particle collisions
