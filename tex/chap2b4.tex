...
and Atomic Phy\-sics Module} \label{sec2.4}
...
either from external A\&M data files such as \texttt{FILNAM} = \texttt{HYDHEL}, = \texttt{METHAN}, = \texttt{AMJUEL}, = \texttt{H2VIBR},
...
This option uses the ADAS adf11 file format as guidance and is developed/adap\-ted from it for more general
A\&M data structures.
...
{\small
\begin{verbatim}
  1 HYDHEL H.2 2.1.8     RC  0  1   ! single step recombination 
                                    ! rate to ground state
  2 HYDHEL H.8 2.1.8     RC  0  1   ! corresponding electron 
                                    ! energy loss/gain
\end{verbatim}
}
...
phase (routines XSTEI, XSTCX, XSTEL, XSTPI, ) of a run from the atomic/mole\-cular data read in input block 4
