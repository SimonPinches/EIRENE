...
$[\si{\per\cubic\centi\metre}] \cdot [$units of $g^*] \cdot [cm] \cdot
...
been in units $[AMP \cdot \si{\second\per\cubic\centi\metre}]$ (``atomic charge density")
rather than [\si{\per\cubic\centi\metre}]. Energy densities would have been in $[W
\cdot \si{\second\per\cubic\centi\metre}]$ rather than $[eV\si{\per\cubic\centi\metre}]$.
\begin{list}{ }{}
\item[\textbf{IADVS }]
...
(\langle i,85\rangle*\langle i,85\rangle+
 ...
 \langle i,1\rangle)$ is the dynamic pressure, scaled to eV~\si{\cubic\centi\metre} units
...
by CVELI2/AMUA/AMUA, (defined in SETCON.F), and the momentum density tallies 85, 89 and 93 are in g \si{\centi\metre\per\second} \si{\per\cubic\centi\metre}.
\end{itemize}
...
energy distribution (ISPTYP=1) , [\si{\per\cubic\centi\metre}/eV]

energy weighted energy distribution (ISPTYP=2) [eV*\si{\per\cubic\centi\metre}/eV]

velocity weighted energy distribution (ISPTYP=3) [\si{\centi\metre\per\second} *\si{\per\cubic\centi\metre}/eV]

\textbf{case b:} direction specified: IDIREC=1


velocity distribution along specified direction, binned in energy units (ISPTYP=1) , [\si{\per\cubic\centi\metre}/eV]

energy weighted velocity distribution along specified direction, put into bins in energy units
(ISPTYP=2) [eV*\si{\per\cubic\centi\metre}/eV]

velocity weighted velocity distribution along specified direction,
put into bins in energy units (ISPTYP=3) [\si{\centi\metre\per\second} *\si{\per\cubic\centi\metre}/eV]
