...
\begin{list}{ }{}
\item[\textbf{NADVI }] Total number of additional volume averaged,
track-length estimated tallies
\item[\textbf{NCLVI }] Total number of
additional volume averaged, collision estimated tallies
\item[\textbf{NALVI }] Total number of tallies defined as algebraic expressions
of other volume averaged tallies
\item[\textbf{NADSI }] Total number
of additional surface averaged tallies
\item[\textbf{NALSI }] Total
number of tallies defined as algebraic expressions of other
surface averaged tallies
\item[\textbf{NADSPC }] Total number of
...
replaced.
\begin{list}{ }{}
\item[\textbf{ICLVR }] as IADVR above, for collision estimated tally
(subroutine UPCUSR).
\item[\textbf{TXTTAL, TXTSPC, TXTUNT }]: as above
\end{list}
\subsection{Algebraic expression in volume averaged tallies}\label{sec2.10C}
\begin{list}{ }{}
\item[\textbf{ALSTRNG }] character string which is interpreted as an
...
\item[\textbf{TXTTAL, TXTSPC, TXTUNT }]
as above.
\end{list}
...
\begin{list}{ }{}
\item[\textbf{ISRFCLL}] flag to choose between surface and cell averages.
...
\item[\textbf{IDIREC, SPCVX, SPCVY, SPCVZ}]
...
\item[\textbf{NSPS, SPCMN, SPCMX }] Number of equidistant energy
...
\item[\textbf{SPC$\_$SHIFT }] shift spectrum by SPC$\_$SHIFT (eV) in printout and plots.

\item[\textbf{SPCPLT$\_$X, SPCPLT$\_$Y }] SPCPLT$\_$X is a flag foreseen to control the
...
\item[\textbf{SPCPLT$\_$SAME }] plot this spectrum into previous
frame
\end{list}
