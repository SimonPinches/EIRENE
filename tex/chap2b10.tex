...
\item[\textbf{SPC\_SHIFT}] shift spectrum by SPC\_SHIFT (\si{\electronvolt}) in printout and plots.

\item[\textbf{SPCPLT\_X, SPCPLT\_Y}] SPCPLT\_X is a flag foreseen to control the
...
\item[\textbf{SPCPLT\_SAME}] plot this spectrum into previous
frame
\end{list}
