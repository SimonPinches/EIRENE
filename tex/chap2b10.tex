...
\cdot \si{\second\per\cubic\centi\metre}]$ rather than $[\si{\electronvolt}\si{\per\cubic\centi\metre}]$.
\begin{list}{ }{}
\item[\textbf{IADVS }]
...
(\langle i,85\rangle*\langle i,85\rangle+
 ...
 \langle i,1\rangle)$ is the dynamic pressure, scaled to \si{\electronvolt}~\si{\cubic\centi\metre} units
...
flux-spectrum (ISPTYP=1) , [\si{\ampere}/\si{\electronvolt}]

or energy-flux spectrum (ISPTYP=2) [\si{\watt}/\si{\electronvolt}]
...
energy distribution (ISPTYP=1) , [\si{\per\cubic\centi\metre}/\si{\electronvolt}]

energy weighted energy distribution (ISPTYP=2) [\si{\electronvolt}*\si{\per\cubic\centi\metre}/\si{\electronvolt}]

velocity weighted energy distribution (ISPTYP=3) [\si{\centi\metre\per\second} *\si{\per\cubic\centi\metre}/\si{\electronvolt}]

\textbf{case b:} direction specified: IDIREC=1


velocity distribution along specified direction, binned in energy units (ISPTYP=1) , [\si{\per\cubic\centi\metre}/\si{\electronvolt}]

energy weighted velocity distribution along specified direction, put into bins in energy units
(ISPTYP=2) [\si{\electronvolt}*\si{\per\cubic\centi\metre}/\si{\electronvolt}]

velocity weighted velocity distribution along specified direction,
put into bins in energy units (ISPTYP=3) [\si{\centi\metre\per\second} *\si{\per\cubic\centi\metre}/\si{\electronvolt}]
...
\item[\textbf{SPC$\_$SHIFT }] shift spectrum by SPC$\_$SHIFT (\si{\electronvolt}) in printout and plots.
