...
by CVELI2/AMUA/AMUA, (defined in SETCON.F), and the momentum density tallies 85, 89 and 93 are in g \si{\centi\metre\per\second} cm$^{-3}$.
\end{itemize}
...
velocity weighted energy distribution (ISPTYP=3) [\si{\centi\metre\per\second} *cm**-3/eV]
...
put into bins in energy units (ISPTYP=3) [\si{\centi\metre\per\second} *cm**-3/eV]
