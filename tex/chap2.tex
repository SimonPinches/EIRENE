...
10^{-19}$), even neutral particle fluxes. Since energies are given in \si{\electronvolt} units, a particle flux $\times$ energy is already in Watt.
...
energy fluxes are given in $\si{\electronvolt} \cdot Amp$, i.e., in $Watt$.
...
is in $g~\si{\centi\metre\per\second} \cdot Amp$ (per cell) and the momentum source density
in the EIRENE tallies for interfacing with plasma codes is then in
$g~\si{\centi\metre\per\second}~Amp~\si{\per\cubic\centi\metre}$.

Hence, conversion from
$g~\si{\centi\metre\per\second}~Amp $
