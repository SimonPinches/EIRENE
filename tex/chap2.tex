...
Note: consequently, e.g., energy densities are in $eV\si{\per\cubic\centi\metre}$, and
energy fluxes are given in $eV \cdot Amp$, i.e., in $Watt$.

Hence: In order to convert from EIRENE \textbf{energy density} units ($eV\si{\per\cubic\centi\metre}$) into  \textbf{pressure}
units in $N/m^2$
...
about $2.7 \cdot 10^{14} \times 0.026~ eV\si{\per\cubic\centi\metre} \approx 7 \cdot 10^{12}~ eV\si{\per\cubic\centi\metre}$, or:
