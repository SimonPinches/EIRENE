...
or for the general 3D grids of tetrahedra) all surfaces are referred to as \ordinalnum{1} grid (x or radial) surfaces,
...
$IRPTE2 and
IRPTA3$\rightarrow
$IRPTE3 are the surface index ranges of the \ordinalnum{2} and \ordinalnum{3} mesh,
...
$IRPTE1 and
IRPTA3$\rightarrow
$IRPTE3 are the surface index ranges of the \ordinalnum{1} and \ordinalnum{3} mesh,
respectively, for which this surface acts as non-default surface.
...
IRPTE1 and
IRPTA2$\rightarrow$
IRPTE2 are the surface index ranges of the \ordinalnum{1} and \ordinalnum{2} mesh,
respectively, for which this surface acts as non-default surface.
