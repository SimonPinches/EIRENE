...
(i.e., POT... and EOT... tallies in \cref{tab3})
...
and $K^+$ (\si{\watt}). These are stored in the POT... and EOT... tallies of \cref{tab3}.
...
and $K^-$ (\si{\watt}) are updated. These are stored in the PRF... and ERF... tallies of
\cref{tab3}.

\item[{= -3 }]
Net currents (e.g. $J^+ - J^-$),
are evaluated, and stored on the POT... and EOT... tallies (see \cref{tab3}).
