...
In case of NLTRA (toroidal geometry approximation), surfaces must be defined in the local coordinate system of toroidal cells centered at the ``magnetic axis", (xa,ya) = (RMTOR,0.), i.e.,
