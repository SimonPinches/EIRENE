...
next. \item[NLIMI] number of surfaces in the input block
\item[TXTSUR] Text to identify a surface (``name of the
...
\item[ILEQUI] The algebraic equations for the surfaces J
...
\item[ILPLG] EIRENE can write out information for a finite element
