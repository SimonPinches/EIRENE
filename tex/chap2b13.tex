...
\textsl{*** 13. Data for nonlinear and time dependent Options }
...
\begin{list}{ }{}
\item[\textbf{NPRNLI }] Total number of test particles in time
...
\item[\textbf{NINITL\_READ}]  (new: 2013) Same as NINITL in block 7: provides random number seed for ``time-stratum" (sampling from census
array  (default: =0, no fresh initialization of random number generator for this stratum)
\item[\textbf{NPRMUL}] (new: 2013) Multiplicative factor for NPRNLI, in order to increase size of census
...
\item[\textbf{NPTST }] Same as NPTS in block 7.
