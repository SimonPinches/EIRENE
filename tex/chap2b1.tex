...
{\bf Meaning of the input flags for operating mode}
...
\item [{\bf NMODE}] Operating mode
\begin{list}{}{}
\item [= 0 ] EIRENE run as stand-alone-code. Code coupling segment
\verb1 couple_Dummy.f 1
may be used. Input block 14 has a fixed format, see section \ref{sec2.14}.
\item [$\ne$ 0 ]
