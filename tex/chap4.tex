...
recombination sources, etc\dots) still have to defined in input
...
At entry \texttt{IF4COP} (see \cref{sec4.1.4} above) these
...
balances of a coupled run (\texttt{TRCBAL} = \texttt{.true.})
