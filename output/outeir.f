...
C
     ...
     .              NLION (ISTRA),NLPLS(ISTRA))
        CALL EIRENE_MASAGE
     .  ('SPECIES INDEX OF SOURCE PARTICLES             ')
...
C  SPECTRA IN SELECTED CELLS
     ...
     .           ESTIML(ISPC)%PSPC%SGMS
      ...
      IF (NSPCPR > 0) CALL EIRENE_OUTSPEC
C
...
C
      CALL EIRENE_MASAGE
     .  ('TEST PARTICLE INFLUX FROM  SOURCE (AMP)       ')
      CALL EIRENE_MASAGE
     .  ('INFLUX/(1.602*E-19) IS THE "ATOMIC" FLUX, PART./S')
...
C
      ...
      CALL
     .  EIRENE_HEADNG('PARTICLE FLUX BALANCE (AMP), NEUTRAL ATOMS',43)
      CALL EIRENE_LEER(1)
C   ATOMS FROM PRIMARY SOURCE
      IF (ANY(WTOTA(1:NATM,ISTRA).NE.0.D0)) THEN
        CALL EIRENE_MASAGE
     .  ('ATOMIC INFLUX FROM PRIMARY SOURCE              ')
...
C
      IF (.NOT.LPPAT) THEN
        IF (LMSPPAT) THEN
        CALL EIRENE_MASAGE
     .  ('ATOMS FROM RECOMBINING BULK IONS               ')
        CALL EIRENE_MASAGE
...
C
      IF (.NOT.LPAAT) THEN
        IF (LMSPAAT) THEN
        CALL EIRENE_MASAGE
     .  ('ATOMS BORN BY ATOM - PLASMA INTERACTIONS       ')
        CALL EIRENE_MASAGE
...
C   ESCAPING FLUX
      IF (.NOT.LPOTAT) THEN
        IF (LMSPOTAT) THEN
        CALL EIRENE_MASAGE
     .  ('ATOMIC EFFLUX ONTO THE SURFACES                ')
        CALL EIRENE_MASAGE
...
C   REFLECTED FLUX
     ...
     .  ('SUM OVER SPECIES                               ')
      ...
      IF (.NOT.LSPTAAT) THEN
        IF (LMSSPTAAT) THEN
        CALL EIRENE_MASAGE
     .  ('FLUX SPUTTERED BY ATOMS, ORIG: ATOMS           ')
        CALL EIRENE_MASAGE
     ...
     .                SPTAATI,LOGATM,ISTRA,0,NATM,0,NSTRA,TEXTS(NSPH+1))
        CALL EIRENE_MASAGE
     .  ('SUM OVER SPECIES                               ')
      ...
      IF (.NOT.LSPTMAT) THEN
        IF (LMSSPTMAT) THEN
        CALL EIRENE_MASAGE
     .  ('FLUX SPUTTERED BY ATOMS, ORIG: MOLECULES       ')
        CALL EIRENE_MASAGE
     ...
     .                SPTMATI,LOGATM,ISTRA,0,NATM,0,NSTRA,TEXTS(NSPH+1))
        CALL EIRENE_MASAGE
     .  ('SUM OVER SPECIES                               ')
      ...
      IF (.NOT.LSPTIAT) THEN
        IF (LMSSPTIAT) THEN
        CALL EIRENE_MASAGE
     .  ('FLUX SPUTTERED BY ATOMS, ORIG: TEST IONS       ')
        CALL EIRENE_MASAGE
     ...
     .             SPTIATI,LOGATM,ISTRA,0,NATM,0,NSTRA,TEXTS(NSPH+1))
        CALL EIRENE_MASAGE
     .  ('SUM OVER SPECIES                               ')
      ...
      IF (.NOT.LSPTPHAT) THEN
        IF (LMSSPTPHAT) THEN
        CALL EIRENE_MASAGE
     .  ('FLUX SPUTTERED BY ATOMS, ORIG: PHOTONS         ')
        CALL EIRENE_MASAGE
     ...
     .             SPTPHATI,LOGATM,ISTRA,0,NATM,0,NSTRA,TEXTS(NSPH+1))
        CALL EIRENE_MASAGE
     .  ('SUM OVER SPECIES                               ')
      ...
      IF (.NOT.LSPTPAT) THEN
        IF (LMSSPTPAT) THEN
        CALL EIRENE_MASAGE
     .  ('FLUX SPUTTERED BY ATOMS, ORIG: BULK IONS       ')
        CALL EIRENE_MASAGE
     ...
     .                SPTPATI,LOGATM,ISTRA,0,NATM,0,NSTRA,TEXTS(NSPH+1))
        CALL EIRENE_MASAGE
     .  ('SUM OVER SPECIES                               ')
...
405   CONTINUE
      CALL EIRENE_MASAGE
     .  ('ABSOLUTE ERRORS IN PARTICLE BALANCE            ')
     ...
     .  ('SUM OVER SPECIES                               ')
      ...
      CALL EIRENE_MASAGE
     .  ('RELATIVE ERRORS IN PARTICLE BALANCE (%)        ')
...
C  MOLECULES FROM PRIMARY SOURCE
      IF (ANY(WTOTM(1:NMOL,ISTRA).NE.0.D0)) THEN
        CALL EIRENE_MASAGE
     .  ('MOLECULAR INFLUX FROM PRIMARY SOURCE          ')
...
C
      IF (.NOT.LPPML) THEN
        IF (LMSPPML) THEN
        CALL EIRENE_MASAGE
     .  ('MOLECULES FROM RECOMBINING BULK IONS          ')
        CALL EIRENE_MASAGE
...
C  ESCAPING MOLECULES
      IF (.NOT.LPOTML) THEN
        IF (LMSPOTML) THEN
        CALL EIRENE_MASAGE
     .  ('MOLECULAR EFFLUX ONTO THE SURFACES             ')
        CALL EIRENE_MASAGE
...
C  REFLECTED MOLECULES
     ...
     .  ('SUM OVER SPECIES                               ')
      ...
      IF (.NOT.LSPTAML) THEN
        IF (LMSSPTAML) THEN
        CALL EIRENE_MASAGE
     .  ('FLUX SPUTTERED BY MOLECULES, ORIG: ATOMS       ')
        CALL EIRENE_MASAGE
     ...
     .                SPTAMLI,LOGMOL,ISTRA,0,NMOL,0,NSTRA,TEXTS(NSPA+1))
        CALL EIRENE_MASAGE
     .  ('SUM OVER SPECIES                               ')
      ...
      IF (.NOT.LSPTMML) THEN
        IF (LMSSPTMML) THEN
        CALL EIRENE_MASAGE
     .  ('FLUX SPUTTERED BY MOLECULES, ORIG: MOLECULES   ')
        CALL EIRENE_MASAGE
     ...
     .                SPTMMLI,LOGMOL,ISTRA,0,NMOL,0,NSTRA,TEXTS(NSPA+1))
        CALL EIRENE_MASAGE
     .  ('SUM OVER SPECIES                               ')
      ...
      IF (.NOT.LSPTIML) THEN
        IF (LMSSPTIML) THEN
        CALL EIRENE_MASAGE
     .  ('FLUX SPUTTERED BY MOLECULES, ORIG: TEST IONS   ')
        CALL EIRENE_MASAGE
     ...
     .                SPTIMLI,LOGMOL,ISTRA,0,NMOL,0,NSTRA,TEXTS(NSPA+1))
        CALL EIRENE_MASAGE
     .  ('SUM OVER SPECIES                               ')
      ...
      IF (.NOT.LSPTPHML) THEN
        IF (LMSSPTPHML) THEN
        CALL EIRENE_MASAGE
     .  ('FLUX SPUTTERED BY MOLECULES, ORIG: PHOTONS     ')
        CALL EIRENE_MASAGE
     ...
     .  ('FLUX SPUTTERED BY MOLECULES, ORIG: PHOTONS     ')
        CALL EIRENE_MASYR1 ('SPTIMLI =',
     .             SPTPHMLI,LOGMOL,ISTRA,0,NMOL,0,NSTRA,TEXTS(NSPA+1))
        CALL EIRENE_MASAGE
     .  ('SUM OVER SPECIES                               ')
      ...
      IF (.NOT.LSPTPML) THEN
        IF (LMSSPTPML) THEN
        CALL EIRENE_MASAGE
     .  ('FLUX SPUTTERED BY MOLECULES, ORIG: BULK IONS   ')
        CALL EIRENE_MASAGE
     ...
     .                SPTPMLI,LOGMOL,ISTRA,0,NMOL,0,NSTRA,TEXTS(NSPA+1))
        CALL EIRENE_MASAGE
     .  ('SUM OVER SPECIES                               ')
      ...
      IF (ABS(SMSPT) > EPS10) THEN
        CALL EIRENE_MASAGE
     .  ('TOTAL FLUX SPUTTERED AS MOLECULES              ')
        CALL EIRENE_MASR1 ('TOTAL=  ',SMSPT)
      END IF
      DO 415 IMOL=0,NMOLI
        DIFM(IMOL,ISTRA)=
...
C  TEST IONS FROM PRIMARY SOURCE
      IF (ANY(WTOTI(1:NION,ISTRA).NE.0.D0)) THEN
        CALL EIRENE_MASAGE
     .  ('TEST IONS INFLUX FROM PRIMARY SOURCE          ')
...
C
      IF (.NOT.LPPIO) THEN
        IF (LMSPPIO) THEN
        CALL EIRENE_MASAGE
     .  ('TEST IONS FROM RECOMBINING BULK IONS          ')
        CALL EIRENE_MASAGE
...
C  ESCAPING TEST IONS
      IF (.NOT.LPOTIO) THEN
        IF (LMSPOTIO) THEN
        CALL EIRENE_MASAGE
     .  ('TEST IONS EFFLUX ONTO THE SURFACES             ')
        CALL EIRENE_MASAGE
...
C  REFLECTED TEST IONS
     ...
     .  ('SUM OVER SPECIES                               ')
      ...
      IF (.NOT.LSPTAIO) THEN
        IF (LMSSPTAIO) THEN
        CALL EIRENE_MASAGE
     .  ('FLUX SPUTTERED BY TEST IONS, ORIG: ATOMS       ')
        CALL EIRENE_MASAGE
     ...
     .             SPTAIOI,LOGION,ISTRA,0,NION,0,NSTRA,TEXTS(NSPAM+1))
        CALL EIRENE_MASAGE
     .  ('SUM OVER SPECIES                               ')
      ...
      IF (.NOT.LSPTMIO) THEN
        IF (LMSSPTMIO) THEN
        CALL EIRENE_MASAGE
     .  ('FLUX SPUTTERED BY TEST IONS, ORIG: MOLECULES   ')
        CALL EIRENE_MASAGE
     ...
     .             SPTMIOI,LOGION,ISTRA,0,NION,0,NSTRA,TEXTS(NSPAM+1))
        CALL EIRENE_MASAGE
     .  ('SUM OVER SPECIES                               ')
      ...
      IF (.NOT.LSPTIIO) THEN
        IF (LMSSPTIIO) THEN
        CALL EIRENE_MASAGE
     .  ('FLUX SPUTTERED BY TEST IONS, ORIG: TEST IONS   ')
        CALL EIRENE_MASAGE
     ...
     .             SPTIIOI,LOGION,ISTRA,0,NION,0,NSTRA,TEXTS(NSPAM+1))
        CALL EIRENE_MASAGE
     .  ('SUM OVER SPECIES                               ')
      ...
      IF (.NOT.LSPTPHIO) THEN
        IF (LMSSPTPHIO) THEN
        CALL EIRENE_MASAGE
     .  ('FLUX SPUTTERED BY TEST IONS, ORIG: PHOTONS     ')
        CALL EIRENE_MASAGE
     ...
     .  ('FLUX SPUTTERED BY TEST IONS, ORIG: PHOTONS     ')
        CALL EIRENE_MASYR1 ('SPTIIOI =',
     .             SPTPHIOI,LOGION,ISTRA,0,NION,0,NSTRA,TEXTS(NSPAM+1))
        CALL EIRENE_MASAGE
     .  ('SUM OVER SPECIES                               ')
      ...
      IF (.NOT.LSPTPIO) THEN
        IF (LMSSPTPIO) THEN
        CALL EIRENE_MASAGE
     .  ('FLUX SPUTTERED BY TEST IONS, ORIG: BULK IONS   ')
        CALL EIRENE_MASAGE
     ...
     .              SPTPIOI,LOGION,ISTRA,0,NION,0,NSTRA,TEXTS(NSPAM+1))
        CALL EIRENE_MASAGE
     .  ('SUM OVER SPECIES                               ')
      ...
      IF (ABS(SMSPT) > EPS10) THEN
        CALL EIRENE_MASAGE
     .  ('TOTAL FLUX SPUTTERED AS TEST IONS              ')
        CALL EIRENE_MASR1 ('TOTAL=  ',SMSPT)
      END IF
      DIFI(0,ISTRA)=0.
      TOTI(0)=0.
...
C   PHOTONS FROM PRIMARY SOURCE
      IF (ANY(WTOTPH(1:NPHOT,ISTRA).NE.0.D0)) THEN
        CALL EIRENE_MASAGE
     .  ('PHOTONIC INFLUX FROM PRIMARY SOURCE            ')
...
C
      IF (.NOT.LPPPHT) THEN
        IF (LMSPPPHT) THEN
        CALL EIRENE_MASAGE
     .  ('PHOTONS FROM RECOMBINING BULK IONS             ')
        CALL EIRENE_MASAGE
...
C   ESCAPING FLUX
      IF (.NOT.LPOTPHT) THEN
        IF (LMSPOTPHT) THEN
        CALL EIRENE_MASAGE
     .  ('PHOTONIC EFFLUX ONTO THE SURFACES              ')
        CALL EIRENE_MASAGE
...
C   REFLECTED FLUX
     ...
     .  ('SUM OVER SPECIES                               ')
      ...
      IF (.NOT.LSPTAPHT) THEN
        IF (LMSSPTAPHT) THEN
        CALL EIRENE_MASAGE
     .  ('FLUX SPUTTERED BY PHOTONS, ORIG: ATOMS         ')
        CALL EIRENE_MASAGE
     ...
     .                SPTAPHTI,LOGPHOT,ISTRA,0,NPHOT,0,NSTRA,TEXTS( +1))
        CALL EIRENE_MASAGE
     .  ('SUM OVER SPECIES                               ')
      ...
      IF (.NOT.LSPTMPHT) THEN
        IF (LMSSPTMPHT) THEN
        CALL EIRENE_MASAGE
     .  ('FLUX SPUTTERED BY PHOTONS, ORIG: MOLECULES     ')
        CALL EIRENE_MASAGE
     ...
     .                SPTMPHTI,LOGPHOT,ISTRA,0,NPHOT,0,NSTRA,TEXTS( +1))
        CALL EIRENE_MASAGE
     .  ('SUM OVER SPECIES                               ')
      ...
      IF (.NOT.LSPTIPHT) THEN
        IF (LMSSPTIPHT) THEN
        CALL EIRENE_MASAGE
     .  ('FLUX SPUTTERED BY PHOTONS, ORIG: TEST IONS     ')
        CALL EIRENE_MASAGE
     ...
     .                SPTIPHTI,LOGPHOT,ISTRA,0,NPHOT,0,NSTRA,TEXTS( +1))
        CALL EIRENE_MASAGE
     .  ('SUM OVER SPECIES                               ')
      ...
      IF (.NOT.LSPTPHPHT) THEN
        IF (LMSSPTPHPHT) THEN
        CALL EIRENE_MASAGE
     .  ('FLUX SPUTTERED BY PHOTONS, ORIG: PHOTONS       ')
        CALL EIRENE_MASAGE
     ...
     .             SPTPHPHTI,LOGPHOT,ISTRA,0,NPHOT,0,NSTRA,TEXTS( +1))
        CALL EIRENE_MASAGE
     .  ('SUM OVER SPECIES                               ')
      ...
      IF (.NOT.LSPTPPHT) THEN
        IF (LMSSPTPPHT) THEN
        CALL EIRENE_MASAGE
     .  ('FLUX SPUTTERED BY PHOTONS, ORIG: BULK IONS     ')
        CALL EIRENE_MASAGE
     ...
     .                SPTPPHTI,LOGPHOT,ISTRA,0,NPHOT,0,NSTRA,TEXTS( +1))
        CALL EIRENE_MASAGE
     .  ('SUM OVER SPECIES                               ')
      ...
      IF (ABS(SMSPT) > EPS10) THEN
        CALL EIRENE_MASAGE
     .  ('TOTAL FLUX SPUTTERED AS PHOTONS                ')
        CALL EIRENE_MASR1 ('TOTAL=  ',SMSPT)
      END IF
...
439   CONTINUE
     ...
     .  ('TRASH: TEST PARTICLES KILLED DUE TO ERRORS     ')
      ...
      IF (TRCBLA.OR.TRCBLM.OR.TRCBLI) THEN
        CALL EIRENE_MASAGE
     .  ('TOTAL ERROR IN PARTICLE FLUXBALANCE            ')
...
C
     ...
     .  ('ENERGY FLUX BALANCE (WATT), NEUTRAL ATOMS',41)
      CALL EIRENE_LEER(1)
      CALL EIRENE_MASAGE
     .  ('ENERGY FLUX FROM PRIMARY SOURCE                ')
      CALL EIRENE_MASR1 ('ETOTA=  ',ETOTA(ISTRA))
      CALL EIRENE_MASAGE
     .  ('ENERGY FLUX FROM RECOMBINING BULK IONS         ')
      CALL EIRENE_MASR1 ('EPATI=  ',EPATI(ISTRA))
      IF (LOGATM(0,ISTRA)) THEN
        IF (LEAAT) THEN
          CALL
     .  EIRENE_MASAGE('ENERGY FLUX FROM ATOM PLASMA INTERACTION       ')
     ...
     .      ('EAAT     SWITCHED OFF => MISSING IN BALANCE    ')
      ...
      IF (LOGMOL(0,ISTRA)) THEN
        IF (LEMAT) THEN
          CALL
     .  EIRENE_MASAGE('ENERGY FLUX FROM MOLECULE PLASMA INTERACTIONS  ')
     ...
     .      ('EMAT     SWITCHED OFF => MISSING IN BALANCE    ')
      ...
      IF (LOGION(0,ISTRA)) THEN
        IF (LEIAT) THEN
          CALL
     .  EIRENE_MASAGE('ENERGY FLUX FROM TEST ION PLASMA INTERACTIONS  ')
...
C
     ...
     .  ('FROM RECOMBINING BULK IONS                     ')
        CALL EIRENE_MASAGE
     .  ('EPIO SWITCHED OFF => MISSING IN BALANCE        ')
        ENDIF
...
C
     ...
     .  ('ENERGY FLUX FROM RECOMBINING BULK IONS         ')
        CALL EIRENE_MASAGE
     .  ('EPPHT SWITCHED OFF => MISSING IN BALANCE       ')
      END IF
      IF (.NOT.LEPHPHT) THEN
        IF (LMSEPHPHT) THEN
        CALL EIRENE_MASAGE
...
469   CONTINUE
     ...
     .  ('ETRASH: ENERGY ABSORBED DUE TO ERRORS          ')
      ...
      IF (TRCBLA.OR.TRCBLM.OR.TRCBLI) THEN
        CALL EIRENE_MASAGE
     .  ('TOTAL ERROR IN ENERGY FLUXBALANCE              ')
        DIFT=DIFA(0,ISTRA)+DIFM(0,ISTRA)+DIFI(0,ISTRA)+DIFPH(0,ISTRA)+
     +       ETRASH(ISTRA)
...
C  PRIMARY SOURCE ORIGINATING FROM BULK PARTICLES
     ...
     .  ('BULK PARTICLE FLUX                             ')
        CALL EIRENE_MASAGE
     .  ('(DEFINING THE TEST PARTICLE SOURCE             ')
        CALL EIRENE_MASAGE
     .  ('STRENGTH (AMP))                                ')
        CALL EIRENE_MASAGE
...
C  PHOTON PLASMA INTERACTION
     ...
     .  ('SUM OVER SPECIES                               ')
      ...
      IF (.NOT.LSPTAPL) THEN
        IF (LMSSPTAPL) THEN
        CALL EIRENE_MASAGE
     .  ('FLUX SPUTTERED BY BULK IONS, ORIG: ATOMS       ')
        CALL EIRENE_MASAGE
     ...
     .  ('SUM OVER SPECIES                               ')
      ...
      IF (.NOT.LSPTMPL) THEN
        IF (LMSSPTMPL) THEN
        CALL EIRENE_MASAGE
     .  ('FLUX SPUTTERED BY BULK IONS, ORIG: MOLECULES   ')
        CALL EIRENE_MASAGE
     ...
     .  ('SUM OVER SPECIES                               ')
      ...
      IF (.NOT.LSPTIPL) THEN
        IF (LMSSPTIPL) THEN
        CALL EIRENE_MASAGE
     .  ('FLUX SPUTTERED BY BULK IONS, ORIG: TEST IONS   ')
        CALL EIRENE_MASAGE
     ...
     .  ('SUM OVER SPECIES                               ')
      ...
      IF (.NOT.LSPTPHPL) THEN
        IF (LMSSPTPHPL) THEN
        CALL EIRENE_MASAGE
     .  ('FLUX SPUTTERED BY BULK IONS, ORIG: PHOTONS     ')
        CALL EIRENE_MASAGE
     ...
     .  ('SUM OVER SPECIES                               ')
      ...
      IF (.NOT.LSPTPPL) THEN
        IF (LMSSPTPPL) THEN
        CALL EIRENE_MASAGE
     .  ('FLUX SPUTTERED BY BULK IONS, ORIG: BULK IONS   ')
        CALL EIRENE_MASAGE
     ...
     .  ('SUM OVER SPECIES                               ')
      ...
      IF (ABS(SMSPT) > EPS10) THEN
        CALL EIRENE_MASAGE
     .  ('TOTAL FLUX SPUTTERED AS BULK IONS              ')
        CALL EIRENE_MASR1 ('TOTAL=  ',SMSPT)
      END IF
      CALL EIRENE_LEER(2)
...
C
      ...
      IF (.NOT.LEPPL) THEN
        IF (LMSEPPL) THEN
        CALL EIRENE_MASAGE
     .  ('BULK ION ENERGY FLUX  BEING                    ')
        CALL EIRENE_MASAGE
     .  ('NEUTRALIZED  (DEFINING THE TEST PARTICLES      ')
        CALL EIRENE_MASAGE
     .  ('SOURCE STRENGTH (WATT))                        ')
        CALL EIRENE_MASAGE
     ...
     .  ('NEUTRALIZED  (DEFINING THE TEST PARTICLES      ')
        CALL EIRENE_MASAGE
     .  ('SOURCE STRENGTH (WATT))                        ')
        CALL EIRENE_MASR1 ('EPPLI=  ',EPPLI(ISTRA))
      ENDIF
      ENDIF
      IF (.NOT.LEAPL) THEN
        IF (LMSEAPL) THEN
     ...
     .  ('EAPL     SWITCHED OFF => MISSING IN BALANCE    ')
      ...
      ELSE IF (EAPLI(ISTRA).NE.0.D0) THEN
        CALL EIRENE_MASAGE
     .  ('ENERGY GAIN DUE TO ATOM PLASMA INTERACTIONS  ')
        CALL EIRENE_MASR1 ('EAPLI=  ',EAPLI(ISTRA))
      ENDIF
      IF (.NOT.LEMPL) THEN
        IF (LMSEMPL) THEN
        CALL EIRENE_MASAGE
     ...
     .  ('EMPL     SWITCHED OFF => MISSING IN BALANCE    ')
      ...
      ELSE IF (EMPLI(ISTRA).NE.0.D0) THEN
        CALL EIRENE_MASAGE
     .  ('ENERGY GAIN FROM MOLECULE PLASMA INTERACTIONS  ')
        CALL EIRENE_MASR1 ('EMPLI=  ',EMPLI(ISTRA))
      ENDIF
      IF (.NOT.LEIPL) THEN
        IF (LMSEIPL) THEN
        CALL EIRENE_MASAGE
     ...
     .  ('EIPL     SWITCHED OFF => MISSING IN BALANCE    ')
      ...
      ELSE IF (EIPLI(ISTRA).NE.0.D0) THEN
        CALL EIRENE_MASAGE
     .  ('ENERGY GAIN FROM TEST ION PLASMA INTERACTIONS  ')
        CALL EIRENE_MASR1 ('EIPLI=  ',EIPLI(ISTRA))
      ENDIF
      IF (.NOT.LEPHPL) THEN
        IF (LMSEPHPL) THEN
        CALL EIRENE_MASAGE
     ...
     .  ('EPHPL    SWITCHED OFF => MISSING IN BALANCE    ')
      ...
      ELSE IF (EPHPLI(ISTRA).NE.0.D0) THEN
        CALL EIRENE_MASAGE
     .  ('ENERGY GAIN FROM PHOTON PLASMA INTERACTIONS  ')
        CALL EIRENE_MASR1 ('EPHPLI= ',EPHPLI(ISTRA))
      ENDIF
      CALL EIRENE_LEER(2)
      ELOSSP=EPPLI(ISTRA)
