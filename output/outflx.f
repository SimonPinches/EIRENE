...
C      REAL(DP) :: HELP(NRAD), HELPP(NLMPGS)
...
C  SURFACE AVERAGED TALLY NO. 1
     ...
     .                   TEXTS(NSPH+1))
            CALL
     .  EIRENE_MASYR1('ST.DEV.% ',VARA1,LGVRA1,ISTRA,0,NATM,0,NSTRA,
     .                   TEXTS(NSPH+1))
C  SURFACE AVERAGED TALLY NO. 26
            CALL
     .  EIRENE_MASYR1('E-FLUX:  ',SUMA2,LOGATM,ISTRA,0,NATM,0,NSTRA,
     .                   TEXTS(NSPH+1))
            CALL
     .  EIRENE_MASYR1('ST.DEV.% ',VARA2,LGVRA2,ISTRA,0,NATM,0,NSTRA,
     .                   TEXTS(NSPH+1))
          ENDIF
C  SURFACE AVERAGED TALLY NO. 7
     ...
     .                   TEXTS(NSPA+1))
            CALL
     .  EIRENE_MASYR1('ST.DEV.% ',VARM1,LGVRM1,ISTRA,0,NMOL,0,NSTRA,
     .                   TEXTS(NSPA+1))
C  SURFACE AVERAGED TALLY NO. 32
            CALL
     .  EIRENE_MASYR1('E-FLUX:  ',SUMM2,LOGMOL,ISTRA,0,NMOL,0,NSTRA,
     .                   TEXTS(NSPA+1))
            CALL
     .  EIRENE_MASYR1('ST.DEV.% ',VARM2,LGVRM2,ISTRA,0,NMOL,0,NSTRA,
     .                   TEXTS(NSPA+1))
          ENDIF
C  SURFACE AVERAGED TALLY NO. 13
     ...
     .                   TEXTS(NSPAM+1))
            CALL
     .  EIRENE_MASYR1('ST.DEV.% ',VARI1,LGVRI1,ISTRA,0,NION,0,NSTRA,
     .                   TEXTS(NSPAM+1))
C  SURFACE AVERAGED TALLY NO. 38
            CALL
     .  EIRENE_MASYR1('E-FLUX:  ',SUMI2,LOGION,ISTRA,0,NION,0,NSTRA,
     .                   TEXTS(NSPAM+1))
            CALL
...
C  SURFACE AVERAGED TALLY NO. 19
          IF (SUMPH.NE.0.D0) THEN
            ...
            CALL
     .  EIRENE_MASYR1('P-FLUX:  ',SUMPH1,LOGPHOT,ISTRA,0,NPHOT,0,
     .                   NSTRA,TEXTS(0+1))
            CALL
     .  EIRENE_MASYR1('ST.DEV.% ',VARPH1,LGVRPH1,ISTRA,0,NPHOT,0,
     .                   NSTRA,TEXTS(0+1))
C  SURFACE AVERAGED TALLY NO. 44
            CALL
     .  EIRENE_MASYR1('E-FLUX:  ',SUMPH2,LOGPHOT,ISTRA,0,NPHOT,0,
     .                   NSTRA,TEXTS(0+1))
            CALL
...
C  SURFACE AVERAGED TALLY NO. 25
     ...
     .                   TEXTS(NSPAMI+1))
            CALL
     .  EIRENE_MASYR1('ST.DEV.% ',VARP1,LGVRP1,ISTRA,0,NPLS,0,NSTRA,
     .                   TEXTS(NSPAMI+1))
C  SURFACE AVERAGED TALLY NO. 50
            CALL
     .  EIRENE_MASYR1('E-FLUX:  ',SUMP2,LOGPLS,ISTRA,0,NPLS,0,NSTRA,
     .                   TEXTS(NSPAMI+1))
            CALL
     .  EIRENE_MASYR1('ST.DEV.% ',VARP2,LGVRP2,ISTRA,0,NPLS,0,NSTRA,
     .                   TEXTS(NSPAMI+1))
          ENDIF
          CALL EIRENE_LEER (1)
          WRITE (iunout,*)
...
C  SURFACE AVERAGED TALLY NO. 20
     ...
     .               TEXTS(0+1))
        CALL
     .  EIRENE_MASYR1('ST.DEV.% ',VARPH1,LGVRPH1,ISTRA,0,NPHOT,0,NSTRA,
     .               TEXTS(0+1))
C  SURFACE AVERAGED TALLY NO. 45
        CALL
     .  EIRENE_MASYR1('E-FLUX:  ',SUMPH2,LOGPHOT,ISTRA,0,NPHOT,0,NSTRA,
     .               TEXTS(0+1))
        CALL
     .  EIRENE_MASYR1('ST.DEV.% ',VARPH2,LGVRPH2,ISTRA,0,NPHOT,0,NSTRA,
     .               TEXTS(0+1))
        ENDIF
        CALL EIRENE_LEER (1)
...
C  SURFACE AVERAGED TALLY NO. 51
        CALL EIRENE_MASYR1
     .  ('ATOMS    ',SUMA1,LOGATM,ISTRA,0,NATM,0,NSTRA,TEXTS(NSPH+1))
        CALL EIRENE_MASYR1
     .  ('ST.DEV.% ',VARA1,LGVRA1,ISTRA,0,NATM,0,NSTRA,TEXTS(NSPH+1))
      ENDIF
      IF (SUMMM.NE.0.D0) THEN
C  SURFACE AVERAGED TALLY NO. 56
        CALL EIRENE_MASYR1
     .  ('MOLECULES',SUMM1,LOGMOL,ISTRA,0,NMOL,0,NSTRA,TEXTS(NSPA+1))
        CALL EIRENE_MASYR1
     .  ('ST.DEV.% ',VARM1,LGVRM1,ISTRA,0,NMOL,0,NSTRA,TEXTS(NSPA+1))
      ENDIF
      IF (SUMMI.NE.0.D0) THEN
C  SURFACE AVERAGED TALLY NO. 61
        CALL EIRENE_MASYR1
     .  ('TEST IONS',SUMI1,LOGION,ISTRA,0,NION,0,NSTRA,TEXTS(NSPAM+1))
        CALL EIRENE_MASYR1
     .  ('ST.DEV.% ',VARI1,LGVRI1,ISTRA,0,NION,0,NSTRA,TEXTS(NSPAM+1))
      ENDIF
      IF (SUMMPH.NE.0.D0) THEN
C  SURFACE AVERAGED TALLY NO. 66
        CALL EIRENE_MASYR1
     .  ('PHOTONS',SUMPH1,LOGPHOT,ISTRA,0,NPHOT,0,NSTRA,TEXTS(0+1))
        CALL EIRENE_MASYR1
     .  ('ST.DEV.% ',VARPH1,LGVRPH1,ISTRA,0,NPHOT,0,NSTRA,TEXTS(0+1))
      ENDIF
      IF (SUMMP.NE.0.D0) THEN
C  SURFACE AVERAGED TALLY NO. 71
        CALL EIRENE_MASYR1
     .  ('BULK IONS',SUMP1,LOGPLS,ISTRA,0,NPLS,0,NSTRA,TEXTS(NSPAMI+1))
        CALL EIRENE_MASYR1
     .  ('ST.DEV.% ',VARP1,LGVRP1,ISTRA,0,NPLS,0,NSTRA,TEXTS(NSPAMI+1))
      ENDIF
      CALL EIRENE_LEER (1)
!      WRITE (IUNOUT,*) 'TOT. FLX SPUTTERED BY INCIDENT ATOMS '
      CALL EIRENE_MASR1 ('TOT. FLX',SUMMT)
      CALL EIRENE_LEER(1)
...
C
C   SURFACE AVERAGED TALLY NO. 76
C
      SUMMS=0.
      SUMS(:,ISTRA)=0._DP
      DO 302 IADS=1,NADSI
...
C  SURFACE AVERAGED TALLY NO. 76
        CALL EIRENE_MASYR1
     .    ('ADD.TALLY',SUMS,LOGADS,ISTRA,0,NADS,0,NSTRA,TEXTA)
        CALL EIRENE_MASYR1
     .    ('ST.DEV.% ',VARS,LGVARS,ISTRA,0,NADS,0,NSTRA,TEXTA)
      ENDIF
      CALL EIRENE_LEER (1)
C
305   CONTINUE
...
C
C   SURFACE AVERAGED TALLY NO. 77
C
      SUMMS=0.
      SUML(:,ISTRA)=0._DP
      DO 402 IALS=1,NALSI
...
C  SURFACE AVERAGED TALLY NO. 77
        CALL EIRENE_MASYR1
     .     ('         ',SUML,LOGALS,ISTRA,0,NALS,0,NSTRA,TEXTL)
      ENDIF
      CALL EIRENE_LEER (1)
C
405   CONTINUE
