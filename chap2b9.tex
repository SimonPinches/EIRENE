...
\noindent The statistical performance (FOM, ``figure of merit",
...
{\bf Meaning of the Input Variables for Statistics and non-analog
Methods}
...
\begin{list}{ }{}
\item[{\bf NLPRCA }] conditional expectation estimator (eq.
\ref{eq1.12}) is used for atom species IATM
\item[{\bf NLPRCM }]
conditional expectation estimator is used for molecule species
IMOL
\item[{\bf NLPRCI }] conditional expectation estimator is
used for test ion species IION (not ready to use)
\item[{\bf NLPRCPH }] conditional expectation estimator is
...
\item[{\bf WMINS }] Same as WMINV, but for surface events
...
\item[{\bf IGHC1 IIHC1 IGHC2 IIHC2 }]~
