...
more precise terminology would be ``res\-ponse", see section
\ref{sec3.2}.  By abuse of language we also refer to input data, such as plasma profiles
...
These latter revisions are described in table \ref{tab3a}, and only for that section of the surface tally list
that has been affected.

\

Each {\bf volume averaged response} is a spatial function,
...
{\bf Surface averaged res\-ponses} are also spatial
...
The full resolution wrt. to incident type and emitted species is only implemented in EIRENE revisions svn 360 and later (Jan. 2014), see Table \ref{tab3a}.
...
\subsection{Current status, incl. photon gas tallies (Eirene$_{2002}$ and
younger)}\label{sec.tables-new}
\begin{table}[h]
\caption {\bf Input Tallies for Background,
Input, Module: COMUSR}
\bigskip
\label{tab1} {\footnotesize
\begin{tabular} {|r|l|l|l|l|c|} \hline

 {\bf No} & {\bf Name} & {\bf Macroscopic quantity}
 &  {\bf 1.Dim.}
  & {\bf Units} & {\bf Estim.}   \\ \hline

 -1 & TEIN & Plasma Temperature, Electrons & 1 & $eV$ & /  \\ \hline
 -2 & TIIN & Plasma Temperature, Bulk Ions & NPLSTI & $eV$ & /  \\ \hline
 -3 & DEIN$^*$ & Plasma Density, Electrons & 1 & $cm^{-3}$ & /  \\ \hline
 -4 & DIIN & Plasma Density, Bulk Ions & NPLS & $cm^{-3}$ & / \\ \hline
...
see INDPRO(5) options for magnetic field tallies in input block 5 \ref{sec2.5}.
...
\caption{\bf Volume Averaged Tallies, Output,
Module: CESTIM}
\label{tab2}
\\
\hline
...
\hline\hline
\endhead
 1 & PDENA & Particle density, Atoms & NATM & $cm^{-3}$ & TD
 \\ \hline
 2 & PDENM & Particle density, Molecules & NMOL & $cm^{-3}$ & TD
 \\ \hline
 3 & PDENI & Particle density, Test Ions & NION  & $cm^{-3}$ & TD
 \\ \hline
 4 & PDENPH & Particle density, Photons & NPHOT  & $cm^{-3}$ & TD
 \\ \hline
 5 & EDENA & Energy density, Atoms & NATM       & eV*$cm^{-3}$ & TE
 \\ \hline
 6 & EDENM & Energy density, Molecules & NMOL   & eV*$cm^{-3}$ & TE
 \\ \hline
 7 & EDENI & Energy density, Test Ions & NION   & eV*$cm^{-3}$ & TE
 \\ \hline
 8 & EDENPH & Energy density, Photons & NPHOT   & eV*$cm^{-3}$ & TE
 \\ \hline
 9 & PAEL & Particle Source (Electrons) from atom-plasma coll.
   & 1 & amp* $cm^{-3}$ & TPS  \\ \hline
 10 & PAAT & Particle Source (Atoms) from atom-plasma coll.
   & NATM & amp*$cm^{-3}$ & TPS \\ \hline
 11 & PAML & Particle Source (Molecules) from atom-plasma coll.
   & NMOL & amp*$cm^{-3}$ & TPS \\  \hline
 12 & PAIO & Particle Source (Test Ions) from atom-plasma coll.
    & NION & amp*$cm^{-3}$ & TPS  \\  \hline
 13 & PAPHT & Particle Source (Photons) from atom-plasma coll.
    & NPHOT & amp*$cm^{-3}$ & TPS  \\  \hline
 14 & PAPL & Particle Source (Bulk Ions) from atom-plasma coll.
    & NPLS & amp*$cm^{-3}$ & TPS  \\  \hline
...
\pagebreak
 ...
 63 & PGENA & Generation limit, Atoms & NATM & amp*$cm^{-3}$ & CG
 \\ \hline
 64 & PGENM & Generation limit, Molecules & NMOL & amp*$cm^{-3}$ & CG
 \\
\hline
\pagebreak
 65 & PGENI & Generation limit, Test ions & NION & amp*$cm^{-3}$ & CG
 \\ \hline
 66 & PGENPH & Generation limit, Photons & NPHOT & amp*$cm^{-3}$ & CG
 \\ \hline
 67 & EGENA & dito, Energy flux, Atoms & NATM & watt*$cm^{-3}$ & CG
 \\ \hline
 68 & EGENM & dito, Energy flux, Molecules & NMOL & watt*$cm^{-3}$ & CG
 \\ \hline
 69 & EGENI & dito, Energy flux, Test ions & NION & watt*$cm^{-3}$ & CG
 \\ \hline
 70 & EGENPH & dito, Energy flux, Photons & NPHOT & watt*$cm^{-3}$ & CG
 \\ \hline
...
estimators (\ref{eq1.11}). Default tallies are updated (``scoring")
...
In some instances still collision estimators (\ref{eq1.9}) are
...
%\newpage
%\begin{table}[t]
%\caption {\bf Surface Averaged Tallies,
...
and (emitted) sputtered particle type and species, see Table \ref{tab3a}.
...
{\footnotesize
\begin{longtable}{|r|l|l|l|l|c|}
\caption {\bf Sputter tallies, new version, svn 360 ff, 2014,\\
Output, Module: CESTIM}
\label{tab3a}
\\
\hline
...
\clearpage
\newpage
\subsection{old version, w/o photon gas tallies (Eirene$_{2001}$ and
...
\newpage
\begin{table}[t]
\caption {\bf Volume Averaged Tallies, Output, Common: CESTIM}
...
\\
{\bf Note:} $\underline{Source} $ means: if the sign is positive,
...
\newpage
\begin{table}[t]
\caption {\bf Surface Averaged Tallies, Output, Common: CESTIM}
\bigskip
...
\\
{\bf Note:} The tallies listed here are two dimensional arrays.
