...
111       CONTINUE
          DO 310 J=1,NLIMPS
            ...
            IF (LSPTMAT) SPTMAT(IATM,J)=SPTMAT(IATM,J)*FATM
            IF (LSPTIAT) SPTIAT(IATM,J)=SPTIAT(IATM,J)*FATM
            IF (LSPTPHAT) SPTPHAT(IATM,J)=SPTPHAT(IATM,J)*FATM
            IF (LSPTPAT) SPTPAT(IATM,J)=SPTPAT(IATM,J)*FATM
...
2101    CONTINUE
        DO 2111 IATM=0,NATMI
          ...
          SPTMATI(IATM,ISTRA)=SPTMATI(IATM,ISTRA)*FATM
          SPTIATI(IATM,ISTRA)=SPTIATI(IATM,ISTRA)*FATM
          SPTPHATI(IATM,ISTRA)=SPTPHATI(IATM,ISTRA)*FATM
          SPTPATI(IATM,ISTRA)=SPTPATI(IATM,ISTRA)*FATM
...
115       CONTINUE
          DO 315 J=1,NLIMPS
            ...
            IF (LSPTAML) SPTAML(IMOL,J)=SPTAML(IMOL,J)*FMOL
            IF (LSPTMML) SPTMML(IMOL,J)=SPTMML(IMOL,J)*FMOL
            IF (LSPTIML) SPTIML(IMOL,J)=SPTIML(IMOL,J)*FMOL
            IF (LSPTPHML) SPTPHML(IMOL,J)=SPTPHML(IMOL,J)*FMOL
            IF (LSPTPML) SPTPML(IMOL,J)=SPTPML(IMOL,J)*FMOL
...
2115     CONTINUE
        ...
        DO 2116 IMOL=0,NMOLI
          ...
          SPTAMLI(IMOL,ISTRA)=SPTAMLI(IMOL,ISTRA)*FMOL
          SPTMMLI(IMOL,ISTRA)=SPTMMLI(IMOL,ISTRA)*FMOL
          SPTIMLI(IMOL,ISTRA)=SPTIMLI(IMOL,ISTRA)*FMOL
          SPTPHMLI(IMOL,ISTRA)=SPTPHMLI(IMOL,ISTRA)*FMOL
          SPTPMLI(IMOL,ISTRA)=SPTPMLI(IMOL,ISTRA)*FMOL
...
421       CONTINUE
          DO 422 J=1,NLIMPS
            ...
            IF (LSPTAIO) SPTAIO(IION,J)=SPTAIO(IION,J)*FION
            IF (LSPTMIO) SPTMIO(IION,J)=SPTMIO(IION,J)*FION
            IF (LSPTIIO) SPTIIO(IION,J)=SPTIIO(IION,J)*FION
            IF (LSPTPHIO) SPTPHIO(IION,J)=SPTPHIO(IION,J)*FION
            IF (LSPTPIO) SPTPIO(IION,J)=SPTPIO(IION,J)*FION
...
420     CONTINUE
        ...
        DO 431 IION=0,NIONI
          ...
          SPTAIOI(IION,ISTRA)=SPTAIOI(IION,ISTRA)*FION
          SPTMIOI(IION,ISTRA)=SPTMIOI(IION,ISTRA)*FION
          SPTIIOI(IION,ISTRA)=SPTIIOI(IION,ISTRA)*FION
          SPTPHIOI(IION,ISTRA)=SPTPHIOI(IION,ISTRA)*FION
          SPTPIOI(IION,ISTRA)=SPTPIOI(IION,ISTRA)*FION
...
C
        DO IPHOT=1,NPHOTI
          ...
          DO J=1,NLIMPS
            ...
            IF (LSPTAPHT) SPTAPHT(IPHOT,J)=SPTAPHT(IPHOT,J)*FPHOT
            IF (LSPTMPHT) SPTMPHT(IPHOT,J)=SPTMPHT(IPHOT,J)*FPHOT
            IF (LSPTIPHT) SPTIPHT(IPHOT,J)=SPTIPHT(IPHOT,J)*FPHOT
            IF (LSPTPHPHT) SPTPHPHT(IPHOT,J)=SPTPHPHT(IPHOT,J)*FPHOT
            IF (LSPTPPHT) SPTPPHT(IPHOT,J)=SPTPPHT(IPHOT,J)*FPHOT
        ...
        DO IPHOT=0,NPHOTI
          ...
          SPTAPHTI(IPHOT,ISTRA)=SPTAPHTI(IPHOT,ISTRA)*FPHOT
          SPTMPHTI(IPHOT,ISTRA)=SPTMPHTI(IPHOT,ISTRA)*FPHOT
          SPTIPHTI(IPHOT,ISTRA)=SPTIPHTI(IPHOT,ISTRA)*FPHOT
          SPTPHPHTI(IPHOT,ISTRA)=SPTPHPHTI(IPHOT,ISTRA)*FPHOT
          SPTPPHTI(IPHOT,ISTRA)=SPTPPHTI(IPHOT,ISTRA)*FPHOT
