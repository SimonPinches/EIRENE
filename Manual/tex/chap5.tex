...
The recommended way to compile EIRENE is by using the CMake utility available on multiple platforms \url{https://cmake.org/}. Cmake will ensure that the necessary dependencies are met.
