...
This will generate a default EIRENE library libEIRENE.a in eirene/libRelease with the Dummy interface and default user-routines, where -j enables multi threaded  compilation. EIRENE can also be compiled with different user interfaces. To compile for SOLPS-ITER
