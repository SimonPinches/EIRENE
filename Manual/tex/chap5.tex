...
The loaction of the JSON library and the compiler dependent FORTRAN module 
...
In order to enable OPENMP also add -DOPENMP=ON to the cmake line. In order to use MPI replace gfortran with an MPI compile command such as mpif90. You can also replace gfortran with the intel compiler ifort. You can also add -DCMAKE\_BUILD\_TYPE=DEBUG for a debug build.
