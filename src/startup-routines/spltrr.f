...
C  A SPLITTING SURFACE WILL BE REACHED, REMAINING FLIGHT DISTANCE: ZT.
...
C  EITHER KILL PARTILCE, OR CONTINUE FLIGHT WITH INCREASED WEIGHT 
C
...
C  NINC    : DECIDE SPLITTING OR RUSSIAN ROULETTE FROM SIGN OF NINC*IG, IG A SURFACE PROPERTY
...
C  PUSH PARTILCE TO SPLITTING POSITION (DISTANCE ZT)
C  THEN SPLIT, 
