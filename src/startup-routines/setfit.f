      SUBROUTINE EIRENE_SETFIT(TRCSUR)
...
C
     ...
     .          XP2, XP3, XP4, YP1, YP2, YP3, YP4, DS1, DS2
      ...
      EXTERNAL :: EIRENE_SCHNITP, EIRENE_EXIT_OWN
C
      DO 1 I=1,NLIMI
...
C  WHICH COORDINATE OF SURFACE NO. I IS IGNORABLE?
...
C  SURFACE IE MUST BE GIVEN WITH SAME IGNORABLE COORDINATE AS SURFACE I
C
C  IDENTIFY IGNORABLE COORDINATE OF SURFACE IE
          IF (LINFX) THEN
...
C  TRY TO CONNECT SURFACE I TO SURFACE IE
            IS=1
            CALL EIRENE_SCHNITP(XP1,YP1,XP2,YP2,
     .                          XP3,YP3,XP4,YP4,XS(1),YS(1))
          ELSE
