...
C
      ...
      NFRSTW(51)=NATM
      IF (NLSPCSPT_ATM) NFRSTW(51)=NATM*NATMP
      NFRSTW(52)=NATM
      IF (NLSPCSPT_MOL) NFRSTW(52)=NATM*NMOLP
      NFRSTW(53)=NATM
      IF (NLSPCSPT_ION) NFRSTW(53)=NATM*NIONP
      NFRSTW(54)=NATM
      IF (NLSPCSPT_PHOT) NFRSTW(54)=NATM*NPHOTP
      NFRSTW(55)=NATM
      IF (NLSPCSPT_PLS) NFRSTW(55)=NATM*NPLSP
      NFRSTW(56)=NMOL
      IF (NLSPCSPT_ATM) NFRSTW(56)=NMOL*NATMP
      NFRSTW(57)=NMOL
      IF (NLSPCSPT_MOL) NFRSTW(57)=NMOL*NMOLP
      NFRSTW(58)=NMOL
      IF (NLSPCSPT_ION) NFRSTW(58)=NMOL*NIONP
      NFRSTW(59)=NMOL
      IF (NLSPCSPT_PHOT) NFRSTW(59)=NMOL*NPHOTP
      NFRSTW(60)=NMOL
      IF (NLSPCSPT_PLS) NFRSTW(60)=NMOL*NPLSP
      NFRSTW(61)=NION
      IF (NLSPCSPT_ATM) NFRSTW(61)=NION*NATMP
      NFRSTW(62)=NION
      IF (NLSPCSPT_MOL) NFRSTW(62)=NION*NMOLP
      NFRSTW(63)=NION
      IF (NLSPCSPT_ION) NFRSTW(63)=NION*NIONP
      NFRSTW(64)=NION
      IF (NLSPCSPT_PHOT) NFRSTW(64)=NION*NPHOTP
      NFRSTW(65)=NION
      IF (NLSPCSPT_PLS) NFRSTW(65)=NION*NPLSP
      NFRSTW(66)=NPHOT
      IF (NLSPCSPT_ATM) NFRSTW(66)=NPHOT*NATMP
      NFRSTW(67)=NPHOT
      IF (NLSPCSPT_MOL) NFRSTW(67)=NPHOT*NMOLP
      NFRSTW(68)=NPHOT
      IF (NLSPCSPT_ION) NFRSTW(68)=NPHOT*NIONP
      NFRSTW(69)=NPHOT
      IF (NLSPCSPT_PHOT) NFRSTW(69)=NPHOT*NPHOTP
      NFRSTW(70)=NPHOT
      IF (NLSPCSPT_PLS) NFRSTW(70)=NPHOT*NPLSP
      NFRSTW(71)=NPLS
      IF (NLSPCSPT_ATM) NFRSTW(71)=NPLS*NATMP
      NFRSTW(72)=NPLS
      IF (NLSPCSPT_MOL) NFRSTW(72)=NPLS*NMOLP
      NFRSTW(73)=NPLS
      IF (NLSPCSPT_ION) NFRSTW(73)=NPLS*NIONP
      NFRSTW(74)=NPLS
      IF (NLSPCSPT_PHOT) NFRSTW(64)=NPLS*NPHOTP
      NFRSTW(75)=NPLS
      IF (NLSPCSPT_PLS) NFRSTW(75)=NPLS*NPLSP
