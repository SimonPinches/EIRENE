...
C
     ...
     >                        NSIGI_BGK
      USE EIRMOD_CSDVI_COP, ONLY: EIRENE_ALLOC_CSDVI_COP,
     >                            EIRENE_DEALLOC_CSDVI_COP
      USE EIRMOD_CSDVI_BGK, ONLY: EIRENE_ALLOC_CSDVI_BGK, 
     >                            EIRENE_DEALLOC_CSDVI_BGK, NBGV_STAT, 
     >                            NBGVI_STAT
     ...
     >                        NRCXI, NRBGI, NREII, NRELI, NRPII, NRRCI
      ...
      USE EIRMOD_MPI, ONLY: MPI_COMM_RANK, MPI_COMM_SIZE, 
...
C  AND OTHER DATA FOR NON-ANALOGUE METHODS: WMINV, WMINS
C
        IF (.NOT.NLANA) THEN
          CALL EIRENE_NANALG
        ELSEIF (NLANA) THEN
