...
c  volumetric atomic tallies
        DO 2101 IATM=1,NATMI
          ...
          DO 111 J=1,NSBOX_TAL
            ...
            IF (LRAEL) RAEL(IATM,J)=RAEL(IATM,J)*FATM
  111     CONTINUE
...
cdr  ?? scaling with bulk flux ??
          ...
          RAELI(IATM,ISTRA)=RAELI(IATM,ISTRA)*FATM
...
C
        DO 2115 IMOL=1,NMOLI
          ...
          DO 115 J=1,NSBOX_TAL
            ...
            IF (LRMEL) RMEL(IMOL,J)=RMEL(IMOL,J)*FMOL
  115     CONTINUE
          DO 315 J=1,NLMPGS
...
cdr  ?? scaling with bulk flux ??
          ...
          RMELI(IMOL,ISTRA)=RMELI(IMOL,ISTRA)*FMOL
...
C
        DO 420 IION=1,NIONI
          ...
          DO 421 J=1,NSBOX_TAL
            ...
            IF (LRIEL) RIEL(IION,J)=RIEL(IION,J)*FION
  421     CONTINUE
          DO 422 J=1,NLMPGS
...
cdr  ?? scaling with bulk flux ??
          ...
          RIELI(IION,ISTRA)=RIELI(IION,ISTRA)*FION
