...
C*DK OUTSIG
     ...
     .            DEL_HELP(NCHEN), VSPEC(NCHEN)
      ...
      EXTERNAL :: EIRENE_HEADNG, EIRENE_LEER, EIRENE_MASAGE,
     .            EIRENE_MASR1, EIRENE_MASR2, EIRENE_MASR3,
     .            EIRENE_MASRR2, EIRENE_PAGE, EIRENE_PLTTLY
C
      CALL EIRENE_PAGE
      NCHNI=IABS(NCHENI)
      TSAFE=TEXTS(1)
...
C
        ...
        CALL EIRENE_LEER(1)
        CALL EIRENE_MASR3 ('1ST POINT,"PIVOT POINT" ',
     .               XPIVOT(ICHORI),YPIVOT(ICHORI),ZPIVOT(ICHORI))
        CALL EIRENE_MASR3 ('2ND POINT, INSIDE VOLUME',
...
C  PLOT
            ...
            TXUNIT=REPEAT(' ',24)
            ICURV=ICURV+1
            CALL EIRENE_PLTTLY (ENERGY,DUMFFD,VSPEC,YMN2,YMX2,
     .           IR1,IR2,IRS,
...
C  PLOT, IN WAVELENGTH SCALE
            ...
            FITY=.FALSE.
            TXSPEC=REPEAT(' ',24)
            TXUNIT='PHOTONS/S/CM2/NM/STERAD '
            ICURV=ICURV+1
            CALL EIRENE_PLTTLY (XPLEN,WLDUMFFD,VSPEC,YMN2,YMX2,
     .           IR1,IR2,IRS,
     .           1,TXTALL,TXSPEC,TXUNIT,TXTRUN,TXHEAD,
