...
CPG!$OMP& EXML,EXIO,EXPL,VXDENX,VYDENX,VZDENX,MXPL,PXX,EXX,
CYM 05/04 PUTTING VX,MX .. BACK 
CYM + REMOVING ESTIMV,ESTIMS-> REDUCE + IN MCARLO INSTEAD OF THREADP.
!$OMP& EXML,EXIO,EXPL,VXDENX,VYDENX,VZDENX,MXPL,PXX,EXX)
CYM!$OMP& EXML,EXIO,EXPL,PXX,EXX,
CYM!$OMP& ESTIMS,ESTIMV)
CYM END 05/04
