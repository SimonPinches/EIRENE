      ...
      PUBLIC :: EIRENE_ALLOC_CSDVI_BGK, EIRENE_DEALLOC_CSDVI_BGK,
     P          EIRENE_INIT_CSDVI_BGK
     ...
     I  NBGV_STAT, NSBGK, NBGVI_STAT
      ...
      SUBROUTINE EIRENE_ALLOC_CSDVI_BGK
     ...
     .      ' CSDVI_BGK ',(4*NRTALS+3)*NBGV_STAT*8
      ...
      CALL EIRENE_INIT_CSDVI_BGK

      RETURN
      END SUBROUTINE EIRENE_ALLOC_CSDVI_BGK


      SUBROUTINE EIRENE_DEALLOC_CSDVI_BGK
      ...
      RETURN
      END SUBROUTINE EIRENE_DEALLOC_CSDVI_BGK


      SUBROUTINE EIRENE_INIT_CSDVI_BGK
      ...
      RETURN
      END SUBROUTINE EIRENE_INIT_CSDVI_BGK

      END MODULE EIRMOD_CSDVI_BGK
