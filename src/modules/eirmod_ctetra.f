     ...
     P          EIRENE_INIT_CTETRA, EIRENE_BROADCAST_CTETRA,
     ...
     .                  (17*NTETRA+MCTET2)*4
      ...
      SUBROUTINE EIRENE_BROADCAST_CTETRA
      USE EIRMOD_CPES, ONLY : MY_PE
      USE EIRMOD_MPI
      INTEGER :: IER

      IF (MY_PE /= 0) CALL EIRENE_ALLOC_CTETRA
      ...
      END SUBROUTINE EIRENE_BROADCAST_CTETRA
