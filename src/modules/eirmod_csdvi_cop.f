C PROBABLY THIS ENTIRE ROUTINE IS REDUNDANT; BECAUSE COPV IS A REGULAR
C TALLY; FOR WHICH VARIANCES CAN BE REQUESTED ANYWAY
C REMOVE ALL ARRAYS SIGMA_COP,.... etc...
