     ...
     I         NSPSCL(:), NSPNEW(:)
      ...
      INTEGER, PUBLIC, SAVE ::
     I         NCHORI,    NCHORD,    NCHENI,  MOD_ADDV
      ...
      TYPE TCONTRIB
        INTEGER :: ISP, ITP, IRATIO, IRC, IRC_RAT
        CHARACTER(8) :: FNAME, FRATIO
        CHARACTER(4) :: H2, RAT_H2
        CHARACTER(9) :: REACTION, RAT_REACTION
        CHARACTER(3) :: CR, RAT_CR       
      END TYPE TCONTRIB
      ...
      TYPE TEMIS_MODEL
        ...
        INTEGER :: NO_COMPO, L1, L2, IADV_TOTAL
        REAL(DP) :: FAC, ENERGY
