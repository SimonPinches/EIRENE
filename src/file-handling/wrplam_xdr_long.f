...
C
      SUBROUTINE EIRENE_WRPLAM_XDR_LONG(TRCFLE,IFLG)
...
C
      ...
      CALL FXDRDBL (IUN,EXIN,NRAD)
      CALL FXDRDBL (IUN,EYIN,NRAD)
      CALL FXDRDBL (IUN,EZIN,NRAD)
      CALL FXDRDBL (IUN,EFIN,NRAD)
      ...
      IF (ALLOCATED(CORNER_PROFILES))
     .  CALL FXDRDBL (IUN,CORNER_PROFILES,SIZE(CORNER_PROFILES))
...
C
C
      ENTRY EIRENE_RPLAM_XDR_LONG(TRCFLE,IFLG)
C
