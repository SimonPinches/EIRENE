...
C
     ...
     .                   ZLIMS(I,JS),I=1,ILIN(JS))
      CALL EIRENE_XSHADD (-ZX0,JS,JS)
      CALL EIRENE_YSHADD (-ZY0,JS,JS)
      CALL EIRENE_ZSHADD (-ZZ0,JS,JS)
      CALL EIRENE_ROTADD (AFF,AFFI,JS,JS)
...
C
      CALL EIRENE_ZYLND2
     .  (ZX0,ZY0,ZZ0,ZVX,ZVY,ZVZ,TAR,RZYL,NZAD+2,NINNE,NIN,
     .     ILCOL(JS),IGFIL(JS).NE.0,JS,4,AL,4,AR,PHIAN,PHIEN,20,IPAR)
C
      RETURN
      END SUBROUTINE EIRENE_ZYLPLN
