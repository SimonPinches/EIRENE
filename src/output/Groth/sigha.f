...
!    .                 NADVI+7)
     ...
     .          (ISTRA,NADVI+1,NADVI+2,NADVI+3,NADVI+4,NADVI+5,NADVI+6,
     .                 NADVI+7)
          elseif (PEN.EQ.2.061_DP) THEN 
            write (iunout,*) 'd2_fulcher'
            CALL EIRENE_d2_fulcher
     .          (ISTRA,NADVI+1,NADVI+2,NADVI+3,NADVI+4,NADVI+5,NADVI+6,
     .                 NADVI+7,NADVI+8)
          elseif (PEN.EQ.11.271_DP) THEN 
            write (iunout,*) 'd2_werner '
            CALL EIRENE_d2_werner
     .          (ISTRA,NADVI+1,NADVI+2,NADVI+3,NADVI+4,NADVI+5,NADVI+6,
     .                 NADVI+7,NADVI+8)
          elseif (PEN.EQ.7.749_DP) THEN 
            write (iunout,*) ' d2_lyman '
            CALL EIRENE_d2_lyman
     .          (ISTRA,NADVI+1,NADVI+2,NADVI+3,NADVI+4,NADVI+5,NADVI+6,
     .                 NADVI+7,NADVI+8)
          else
            WRITE (IUNOUT,*) 'NO LINE DEFINITION FOUND FOR PEN=',PEN
            WRITE (IUNOUT,*) 'SIGNAL IS SET TO 0'
            ADDV(NADVI+1:NADVI+8,:) = 0._DP
          endif
...
C
      ...
      PSIG(8)=PSIG(8)+ZDS*ADDV(NADVI+8,NCELC)
      ...
      IF (LARGST) THEN
        ...
        ARGST(8,JJJ)=ADDV(NADVI+8,NCELC)
      END IF
C
      RETURN
