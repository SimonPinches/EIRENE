...
C
      TXTTAL(IAD1,NTALA) ='LY_ALPHA, H ALPHA SOURCE RATE             '
      TXTSPC(IAD1,NTALA) ='GROUNDSTATE             '
      TXTUNT(IAD1,NTALA) ='PHOTONS/S/CM**3         '

      TXTTAL(IAD2,NTALA) ='LY_ALPHA, H ALPHA SOURCE RATE             '
      TXTSPC(IAD2,NTALA) ='CONTINUUM               '
      TXTUNT(IAD2,NTALA) ='PHOTONS/S/CM**3         '

      TXTTAL(IAD3,NTALA) ='LY_ALPHA, H ALPHA SOURCE RATE             '
