...
!dr           changed from 3-->2  to 5-->2
      SUBROUTINE EIRENE_BA_GAMMA (IST,IAD1,IAD2,IAD3,IAD4,IAD5,IAD6,
     .                                IADS)
c
