...
C  PRINT SELECTED (AND NON-ZERO) TALLIES OTHER THAN TALLY 0 AND TALLY NTALR
...
C  SPUTTERED ATOMIC FLUXES (I.E. PARTICLES SPUTTERED AS ATOMS IATM=1,NATMI)
      ...
      IF (.NOT.LSPTAAT) THEN
        IF (LMSSPTAAT) THEN
        CALL EIRENE_MASAGE
     .  ('ATOMIC FLUX SPUTTERED, ORIG: ATOMS           ')
        CALL EIRENE_MASAGE
     ...
     .  ('SUM OVER SPECIES                               ')
      ...
      IF (.NOT.LSPTMAT) THEN
        IF (LMSSPTMAT) THEN
        CALL EIRENE_MASAGE
     .  ('ATOMIC FLUX SPUTTERED, ORIG: MOLECULES       ')
        CALL EIRENE_MASAGE
     ...
     .  ('SUM OVER SPECIES                               ')
      ...
      IF (.NOT.LSPTIAT) THEN
        IF (LMSSPTIAT) THEN
        CALL EIRENE_MASAGE
     .  ('ATOMIC FLUX SPUTTERED, ORIG: TEST IONS       ')
        CALL EIRENE_MASAGE
     ...
     .  ('SUM OVER SPECIES                               ')
      ...
      IF (.NOT.LSPTPHAT) THEN
        IF (LMSSPTPHAT) THEN
        CALL EIRENE_MASAGE
     .  ('ATOMIC FLUX SPUTTERED, ORIG: PHOTONS         ')
        CALL EIRENE_MASAGE
     ...
     .  ('SUM OVER SPECIES                               ')
      ...
      IF (.NOT.LSPTPAT) THEN
        IF (LMSSPTPAT) THEN
        CALL EIRENE_MASAGE
     .  ('ATOMIC FLUX SPUTTERED, ORIG: BULK IONS       ')
        CALL EIRENE_MASAGE
...
C  SPUTTERED MOLECULAR FLUXES (I.E. PARTICLES SPUTTERED AS MOLECULES IMOL=1,NMOLI)
      ...
      IF (.NOT.LSPTAML) THEN
        IF (LMSSPTAML) THEN
        CALL EIRENE_MASAGE
     .  ('MOLECULAR FLUX SPUTTERED, ORIG: ATOMS       ')
        CALL EIRENE_MASAGE
     ...
     .  ('SUM OVER SPECIES                               ')
      ...
      IF (.NOT.LSPTPHML) THEN
        IF (LMSSPTPHML) THEN
        CALL EIRENE_MASAGE
     .  ('MOLECULAR FLUX SPUTTERED, ORIG: PHOTONS     ')
        CALL EIRENE_MASAGE
     ...
     .  ('TOTAL FLUX SPUTTERED AS MOLECULES              ')
      ...
      IF (ABS(SPTMTTI(ISTRA)) > EPS10) THEN
        CALL EIRENE_MASAGE
     .  ('TOTAL FLUX SPUTTERED BY MOLECUES               ')
...
C  SPUTTERED TEST ION FLUXES (I.E. PARTICLES SPUTTERED AS TEST IONS IION=1,NIONI)
      ...
      IF (.NOT.LSPTAIO) THEN
        IF (LMSSPTAIO) THEN
        CALL EIRENE_MASAGE
     .  ('TEST ION FLUX SPUTTERED, ORIG: ATOMS       ')
        CALL EIRENE_MASAGE
     ...
     .  ('SUM OVER SPECIES                               ')
      ...
      IF (.NOT.LSPTMIO) THEN
        IF (LMSSPTMIO) THEN
        CALL EIRENE_MASAGE
     .  ('TEST ION FLUX SPUTTERED, ORIG: MOLECULES   ')
        CALL EIRENE_MASAGE
     ...
     .  ('SUM OVER SPECIES                               ')
      ...
      IF (.NOT.LSPTIIO) THEN
        IF (LMSSPTIIO) THEN
        CALL EIRENE_MASAGE
     .  ('TEST ION FLUX SPUTTERED, ORIG: TEST IONS   ')
        CALL EIRENE_MASAGE
     ...
     .  ('SUM OVER SPECIES                               ')
      ...
      IF (.NOT.LSPTPHIO) THEN
        IF (LMSSPTPHIO) THEN
        CALL EIRENE_MASAGE
     .  ('TEST ION FLUX SPUTTERED, ORIG: PHOTONS     ')
        CALL EIRENE_MASAGE
     ...
     .  ('SUM OVER SPECIES                               ')
      ...
      IF (.NOT.LSPTPIO) THEN
        IF (LMSSPTPIO) THEN
        CALL EIRENE_MASAGE
     .  ('TEST ION FLUX SPUTTERED, ORIG: BULK IONS   ')
        CALL EIRENE_MASAGE
     ...
     .  ('TOTAL FLUX SPUTTERED AS TEST IONS              ')
      ...
      IF (ABS(SPTITTI(ISTRA)) > EPS10) THEN
        CALL EIRENE_MASAGE
     .  ('TOTAL FLUX SPUTTERED BY TEST IONS              ')
...
C  SPUTTERED PHOTON FLUXES (I.E. PARTICLES SPUTTERED AS PHOTONS IPHOT=1,NPHOTI)
      ...
      IF (.NOT.LSPTAPHT) THEN
        IF (LMSSPTAPHT) THEN
        CALL EIRENE_MASAGE
     .  ('PHOTON FLUX SPUTTERED, ORIG: ATOMS         ')
        CALL EIRENE_MASAGE
     ...
     .  ('SUM OVER SPECIES                               ')
      ...
      IF (.NOT.LSPTMPHT) THEN
        IF (LMSSPTMPHT) THEN
        CALL EIRENE_MASAGE
     .  ('PHOTON FLUX SPUTTERED, ORIG: MOLECULES     ')
        CALL EIRENE_MASAGE
     ...
     .  ('SUM OVER SPECIES                               ')
      ...
      IF (.NOT.LSPTIPHT) THEN
        IF (LMSSPTIPHT) THEN
        CALL EIRENE_MASAGE
     .  ('PHOTON FLUX SPUTTERED, ORIG: TEST IONS     ')
        CALL EIRENE_MASAGE
     ...
     .  ('SUM OVER SPECIES                               ')
      ...
      IF (.NOT.LSPTPHPHT) THEN
        IF (LMSSPTPHPHT) THEN
        CALL EIRENE_MASAGE
     .  ('PHOTON FLUX SPUTTERED, ORIG: PHOTONS       ')
        CALL EIRENE_MASAGE
     ...
     .  ('SUM OVER SPECIES                               ')
      ...
      IF (.NOT.LSPTPPHT) THEN
        IF (LMSSPTPPHT) THEN
        CALL EIRENE_MASAGE
     .  ('PHOTON FLUX SPUTTERED, ORIG: BULK IONS     ')
        CALL EIRENE_MASAGE
     ...
     .  ('TOTAL FLUX SPUTTERED AS PHOTONS                ')
      ...
      IF (ABS(SPTPHTTI(ISTRA)) > EPS10) THEN
        CALL EIRENE_MASAGE
     .  ('TOTAL FLUX SPUTTERED BY PHOTONS                ')
...
C  SPUTTERED BULK ION FLUXES (I.E. PARTICLES SPUTTERED AS BULK IONS IPLS=1,NPLSI)
      ...
      IF (.NOT.LSPTAPL) THEN
        IF (LMSSPTAPL) THEN
        CALL EIRENE_MASAGE
     .  ('BULK ION FLUX SPUTTERED, ORIG: ATOMS       ')
        CALL EIRENE_MASAGE
     ...
     .  ('SUM OVER SPECIES                               ')
      ...
      IF (.NOT.LSPTMPL) THEN
        IF (LMSSPTMPL) THEN
        CALL EIRENE_MASAGE
     .  ('BULK ION FLUX SPUTTERED, ORIG: MOLECULES   ')
        CALL EIRENE_MASAGE
     ...
     .  ('SUM OVER SPECIES                               ')
      ...
      IF (.NOT.LSPTIPL) THEN
        IF (LMSSPTIPL) THEN
        CALL EIRENE_MASAGE
     .  ('BULK ION FLUX SPUTTERED, ORIG: TEST IONS   ')
        CALL EIRENE_MASAGE
     ...
     .  ('SUM OVER SPECIES                               ')
      ...
      IF (.NOT.LSPTPHPL) THEN
        IF (LMSSPTPHPL) THEN
        CALL EIRENE_MASAGE
     .  ('BULK ION FLUX SPUTTERED, ORIG: PHOTONS     ')
        CALL EIRENE_MASAGE
     ...
     .  ('SUM OVER SPECIES                               ')
      ...
      IF (.NOT.LSPTPPL) THEN
        IF (LMSSPTPPL) THEN
        CALL EIRENE_MASAGE
     .  ('BULK ION FLUX SPUTTERED, ORIG: BULK IONS   ')
        CALL EIRENE_MASAGE
     ...
     .  ('TOTAL FLUX SPUTTERED AS BULK IONS              ')
      ...
      IF (ABS(SPTPLTTI(ISTRA)) > EPS10) THEN
        CALL EIRENE_MASAGE
     .  ('TOTAL FLUX SPUTTERED BY BULK IONS              ')
