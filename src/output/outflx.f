...
C  SURFACE-AVERAGED TALLY NO. 1
     ...
     .       SUMA1,LOGATM,ISTRA,0,NATM,0,NSTRA,TEXTS(NSPH+1))
            CALL EIRENE_MASYR1('ST.DEV.% ',
     .       VARA1,LGVRA1,ISTRA,0,NATM,0,NSTRA,TEXTS(NSPH+1))
C  SURFACE-AVERAGED TALLY NO. 26
            CALL EIRENE_MASYR1('E-FLUX:  ',
     .       SUMA2,LOGATM,ISTRA,0,NATM,0,NSTRA,TEXTS(NSPH+1))
            CALL EIRENE_MASYR1('ST.DEV.% ',
     .       VARA2,LGVRA2,ISTRA,0,NATM,0,NSTRA,TEXTS(NSPH+1))
          ENDIF
C  SURFACE-AVERAGED TALLY NO. 7
          IF (SUMM.NE.0.D0) THEN
            WRITE (iunout,*) 'INCIDENT: MOLECULES'
            CALL EIRENE_MASYR1('P-FLUX:  ',
     .       SUMM1,LOGMOL,ISTRA,0,NMOL,0,NSTRA,TEXTS(NSPA+1))
            CALL EIRENE_MASYR1('ST.DEV.% ',
     .       VARM1,LGVRM1,ISTRA,0,NMOL,0,NSTRA,TEXTS(NSPA+1))
C  SURFACE-AVERAGED TALLY NO. 32
            CALL EIRENE_MASYR1('E-FLUX:  ',
     .       SUMM2,LOGMOL,ISTRA,0,NMOL,0,NSTRA,TEXTS(NSPA+1))
            CALL EIRENE_MASYR1('ST.DEV.% ',
     .       VARM2,LGVRM2,ISTRA,0,NMOL,0,NSTRA,TEXTS(NSPA+1))
          ENDIF
C  SURFACE-AVERAGED TALLY NO. 13
          IF (SUMI.NE.0.D0) THEN
            WRITE (iunout,*) 'INCIDENT: TEST IONS'
            CALL EIRENE_MASYR1('P-FLUX:  ',
     .       SUMI1,LOGION,ISTRA,0,NION,0,NSTRA,TEXTS(NSPAM+1))
            CALL EIRENE_MASYR1('ST.DEV.% ',
     .       VARI1,LGVRI1,ISTRA,0,NION,0,NSTRA,TEXTS(NSPAM+1))
C  SURFACE-AVERAGED TALLY NO. 38
            CALL EIRENE_MASYR1('E-FLUX:  ',
     .       SUMI2,LOGION,ISTRA,0,NION,0,NSTRA,TEXTS(NSPAM+1))
            CALL EIRENE_MASYR1('ST.DEV.% ',
     .       VARI2,LGVRI2,ISTRA,0,NION,0,NSTRA,TEXTS(NSPAM+1))
          ENDIF
C  SURFACE-AVERAGED TALLY NO. 19
          IF (SUMPH.NE.0.D0) THEN
            WRITE (iunout,*) 'INCIDENT: PHOTONS'
            CALL EIRENE_MASYR1('P-FLUX:  ',
     .       SUMPH1,LOGPHOT,ISTRA,0,NPHOT,0,NSTRA,TEXTS(0+1))
            CALL EIRENE_MASYR1('ST.DEV.% ',
     .       VARPH1,LGVRPH1,ISTRA,0,NPHOT,0,NSTRA,TEXTS(0+1))
C  SURFACE-AVERAGED TALLY NO. 44
            CALL EIRENE_MASYR1('E-FLUX:  ',
     .       SUMPH2,LOGPHOT,ISTRA,0,NPHOT,0,NSTRA,TEXTS(0+1))
            CALL EIRENE_MASYR1('ST.DEV.% ',
     .       VARPH2,LGVRPH2,ISTRA,0,NPHOT,0,NSTRA,TEXTS(0+1))
          ENDIF
C  SURFACE-AVERAGED TALLY NO. 25
          IF (SUMP.NE.0.D0) THEN
            WRITE (iunout,*) 'INCIDENT: BULK IONS (RECYCLING SOURCE)'
            CALL EIRENE_MASYR1('P-FLUX:  ',
     .       SUMP1,LOGPLS,ISTRA,0,NPLS,0,NSTRA,TEXTS(NSPAMI+1))
            CALL EIRENE_MASYR1('ST.DEV.% ',
     .       VARP1,LGVRP1,ISTRA,0,NPLS,0,NSTRA,TEXTS(NSPAMI+1))
C  SURFACE-AVERAGED TALLY NO. 50
            CALL EIRENE_MASYR1('E-FLUX:  ',
     .       SUMP2,LOGPLS,ISTRA,0,NPLS,0,NSTRA,TEXTS(NSPAMI+1))
            CALL EIRENE_MASYR1('ST.DEV.% ',
     .       VARP2,LGVRP2,ISTRA,0,NPLS,0,NSTRA,TEXTS(NSPAMI+1))
          ENDIF
          CALL EIRENE_LEER (1)
          WRITE (iunout,*)
