...
C  SET REDUCED POPULATION COEFFICIENTS FROM AMJUEL FITS
        ...
        DAT  = EIRENE_OTHER_RATE_COEFF(IR+1,NCELL,TEF,DEF,.TRUE.,0)
        DPL  = EIRENE_OTHER_RATE_COEFF(IR+2,NCELL,TEF,DEF,.TRUE.,0)
        DMO  = EIRENE_OTHER_RATE_COEFF(IR+3,NCELL,TEF,DEF,.TRUE.,0)
        DIO2 = EIRENE_OTHER_RATE_COEFF(IR+4,NCELL,TEF,DEF,.TRUE.,0)
        DIO3 = EIRENE_OTHER_RATE_COEFF(IR+5,NCELL,TEF,DEF,.TRUE.,0)
        DNM  = EIRENE_OTHER_RATE_COEFF(IR+6,NCELL,TEF,DEF,.TRUE.,0)

C  RATIO OF DENSITIES: H- TO H2, COLL. EQUIL. IN VIBRATION
C  (ONLY TE-DEPENDENT)

        RATIO7 = EIRENE_OTHER_RATE_COEFF(JR+1,NCELL,TEF,DEF,.TRUE.,0)

C  RATIO OF DENSITIES: H2+ TO H2, INCL. ION CONVERSION, COLL. EQUIL. IN VIBRATION

        RATIO2 = EIRENE_OTHER_RATE_COEFF(JR+3,NCELL,TEF,DEF,.TRUE.,0)

C  RATIO OF DENSITIES: H3+ TO H2, = [RATIO3  * NH2+/NE]
C  (ONLY TE-DEPENDENT)

        RATIO3 = EIRENE_OTHER_RATE_COEFF(JR+2,NCELL,TEF,DEF,.TRUE.,0)
