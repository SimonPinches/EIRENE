C
C
      SUBROUTINE EIRENE_ROTADD(A,AI,ILINI,ILEND)
C
C  TRANSFORM COORDINATE SYSTEM FOR ADDITIONAL SURFACES
C  COORDINATES OF A POINT IN OLD SYSTEM (X,Y,Z)
C  COORDINATES OF A POINT IN NEW SYSTEM (X',Y',Z')
C
C    X'         X     X          X'                           -1  T
...
C   CHANGE COEFFICIENTS FOR ALGEBRAIC EQUATION, TRY TO KEEP INVARIANTS
          ...
          DEL=EIRENE_DETER(A4LM(I),A7LM(I)/2._DP,A9LM(I)/2._DP,
     .              A7LM(I)/2._DP,
