...
C  E.G. FOR CROSS SECTIONS WITH NON ZERO THRESHOLD, JUST RETURN ZERO BELOW THRESHOLD
        EIRENE_EXTRAP=EPS30   !        EIRENE_EXTRAP=0.

      ELSEIF (IFLAG.EQ.2) THEN
C  JANEV TYPE 1, HIGH ENERGY EXTRAPOLATION OF CROSS SECTIONS
C  EXTRAPOLATION AT HIGH ENERGY END FOR REACTIONS WITH NON A ZERO THRESHOLD
