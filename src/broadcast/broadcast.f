...
c  some array A(0:NSTRA)) that include sum over strata
     ...
     .                0,MPI_COMM_WORLD,ier)
      ...
      CALL MPI_BCAST (TABEI1,NRDS*NSTORDR,MPI_REAL8,
     .                0,MPI_COMM_WORLD,ier)
     ...
     .                0,MPI_COMM_WORLD,ier)
      ...
      CALL MPI_BCAST (FACREI,NRDS*2,MPI_REAL8,0,MPI_COMM_WORLD,ier)
      CALL MPI_BCAST (FACRCX,NRCX*2,MPI_REAL8,0,MPI_COMM_WORLD,ier)

      CALL MPI_BCAST (PELEI,NRDS,MPI_REAL8,0,MPI_COMM_WORLD,ier)
...
c  EL post collision energetics 
     ...
     .                0,MPI_COMM_WORLD,ier)
      ...
      CALL MPI_BCAST (EIOEI,NRDS*NIONP*2,MPI_REAL8,0,MPI_COMM_WORLD,ier)
     ...
     .                0,MPI_COMM_WORLD,ier)
      ...
      CALL MPI_BCAST (IPATEI,NRDS*NATMP,MPI_INTEGER,
     .                0,MPI_COMM_WORLD,ier)
