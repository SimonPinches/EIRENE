...
cdr
     ...
     >    , ONLY : EIRENE_BROADCAST_PHOTON
      ...
      CALL EIRENE_BROADCAST_PARMMOD
      CALL EIRENE_BROADCAST_CCONA

      CALL EIRENE_BROADCAST_CGEOM
      CALL EIRENE_BROADCAST_CGRID
      CALL EIRENE_BROADCAST_CPOLYG
      CALL EIRENE_BROADCAST_CTRIG
      CALL EIRENE_BROADCAST_CTETRA
      CALL EIRENE_BROADCAST_CADGEO
      CALL EIRENE_BROADCAST_CLGIN

      CALL EIRENE_BROADCAST_COMUSR
      CALL EIRENE_BROADCAST_CINIT
      CALL EIRENE_BROADCAST_CZT1
      CALL EIRENE_BROADCAST_CAI
      CALL EIRENE_BROADCAST_CESTIM
      CALL EIRENE_BROADCAST_CLOGAU
      CALL EIRENE_BROADCAST_COMSIG
      CALL EIRENE_BROADCAST_COMSOU
      CALL EIRENE_BROADCAST_COMSPL
      CALL EIRENE_BROADCAST_COMXS
      CALL EIRENE_BROADCAST_COUTAU
      CALL EIRENE_BROADCAST_CSDVI
      CALL EIRENE_BROADCAST_CSTEP
      CALL EIRENE_BROADCAST_CTEXT
      CALL EIRENE_BROADCAST_CTRCEI

cdr  broadcast arrays for interfacing with B2/B2.5 codes family
      CALL EIRENE_BROADCAST_CCOUPL

      CALL EIRENE_BROADCAST_COMNNL
