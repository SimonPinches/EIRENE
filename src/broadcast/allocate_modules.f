...
!pb   USE EIRMOD_CCOUPL
      ...
      USE EIRMOD_COMXS
      USE EIRMOD_CTRIG
!pb   USE EIRMOD_BRAEIR
!pb   USE EIRMOD_EIRBRA
      USE EIRMOD_CLAST
      USE EIRMOD_CPLOT
      USE EIRMOD_CREF
      USE EIRMOD_CSPEI
...
!pb      CALL EIRENE_ASSOCIATE_COMUSR
...
!pb   IF (NMODE .NE. 0) CALL EIRENE_ALLOC_CCOUPL(1)
...
!pb   CALL EIRENE_ALLOC_BRAEIR (NDX,NDY,NFL,IFOFF)
!pb   CALL EIRENE_ALLOC_EIRBRA (NDX,NDY,NFL,NSTRA,IFOFF)
