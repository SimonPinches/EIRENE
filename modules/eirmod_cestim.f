...
C
      ...
      END IF
      IF (LSPTATOT) THEN
        SPTATOT => ESTIMS(NADDW(77)+1,:)
      ELSE
        SPTATOT => CEMETERYS(0,:)
      END IF
      IF (LSPTMTOT) THEN
        SPTMTOT => ESTIMS(NADDW(78)+1,:)
      ELSE
        SPTMTOT => CEMETERYS(0,:)
      END IF
      IF (LSPTITOT) THEN
        SPTITOT => ESTIMS(NADDW(79)+1,:)
      ELSE
        SPTITOT => CEMETERYS(0,:)
      END IF
      IF (LSPTPHTOT) THEN
        SPTPHTOT => ESTIMS(NADDW(80)+1,:)
      ELSE
        SPTPHTOT => CEMETERYS(0,:)
      END IF
      IF (LSPTPLTOT) THEN
        SPTPLTOT => ESTIMS(NADDW(81)+1,:)
      ELSE
...
! surface averaged tallies
        ...
        LSPTMTOT   => LIVTALS(78)
        LSPTITOT   => LIVTALS(79)
        LSPTPHTOT  => LIVTALS(80)
        LSPTPLTOT  => LIVTALS(81)
        LADDS     => LIVTALS(82)
        LALGS     => LIVTALS(83)
        LSPUMP    => LIVTALS(84)
        ...
        LMSSPTATOT  => LMISTALS(77)
        LMSSPTMTOT  => LMISTALS(78)
        LMSSPTITOT  => LMISTALS(79)
        LMSSPTPHTOT => LMISTALS(80)
        LMSSPTPLTOT => LMISTALS(81)
        LMSADDS     => LMISTALS(82)
        LMSALGS     => LMISTALS(83)
