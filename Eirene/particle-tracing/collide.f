...
C
     ...
     .          VY, VZ, VPLASP, RMAIO, RMMIO, RMIIO, BF
     ...
     .           IATMN, IPLSN, IRPI, NCLLO, IPLSV, IMPI, IIPI
...
C  ARE THERE TEST PARTICLE SECONDARIES AT ALL?
        ...
        ENDIF
C
        CALL EIRENE_VELOEI(NCLLO,IREI,VELXO,VELYO,VELZO,VELO)
        XGENER=0.D0
C
...
C
        NFLAG=CFLAG(4,1)
        RMAIO=RMASSA(IOLD)
        CALL EIRENE_VELOPI(NCLLO,VELXO,VELYO,VELZO,VELO,IOLD,NOLD,VELQ,
     .              NFLAG,IRPI,RMAIO)
        XGENER=0.D0
C
C  UPDATE COLLISION ESTIMATORS CONTRIBUTION TO EAAT;EAML;EAIO
