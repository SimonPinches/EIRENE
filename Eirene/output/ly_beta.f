...
*DK LY_BETA
      SUBROUTINE EIRENE_LY_BETA (IST,IAD1,IAD2,IAD3,IAD4,IAD5,IADS)
c
C  SUBROUTINE FOR LY_BETA EMISSIVITY. (LYMAN SERIES)
C  CALLED FROM EIRENE, SECTION DIAGNO, SUBR. SGNAL
...
C
      ...
      REAL(DP) :: DP31(0:8,0:8)
      REAL(DP) :: DM31(0:8,0:8)
      REAL(DP) :: DI31(0:8,0:8)
      REAL(DP) :: DN31(0:8,0:8)
 
      REAL(DP) :: RHMH2(0:8), RH2PH2(0:8,0:8), FP(6)
      REAL(DP) :: DNML3, DION3, DMOL3, DEJ, RATIO2, RATIO7, TEI, DPLS3,
     .          SIGADD1, SIGADD2, SIGADD3, SIGADD4, SIGADD5, DATM3, TEF,
     .          DEF, DA, DPP, DM, DI,  SIGADD, DN, FAC21,
     .          FAC41, FAC51, FAC32, FAC42, FAC52, FAC61, FAC62, FAC63,
     .          POWALF1, POWALF2, FACT, e0031,
