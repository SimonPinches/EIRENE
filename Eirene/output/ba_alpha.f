c Nov.07 copied from halpha: fulcher removed. this version: not tested
c        (fulcher contribution still in old halpha.f)
 
      SUBROUTINE EIRENE_Ba_alpha (IST,IAD1,IAD2,IAD3,IAD4,IAD5,IADS)
c
