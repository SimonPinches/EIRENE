...
C
      IF (SUMMT.EQ.0.D0) THEN
        CALL EIRENE_LEER(1)
        CALL EIRENE_MASAGE
     .  ('NO FLUXES SPUTTERED FROM THIS SURFACE         ')
        CALL EIRENE_LEER(1)
        GOTO 206
      ENDIF
      CALL EIRENE_LEER(1)
...
C  SURFACE AVERAGED TALLY NO. 51
        CALL
     .  EIRENE_MASYR1('ATOMS    ',SUMA1,LOGATM,ISTRA,0,NATM,0,NSTRA,
     .               TEXTS(NSPH+1))
        CALL
     .  EIRENE_MASYR1('ST.DEV.% ',VARA1,LGVRA1,ISTRA,0,NATM,0,NSTRA,
     .               TEXTS(NSPH+1))
...
C  SURFACE AVERAGED TALLY NO. 52
        CALL
     .  EIRENE_MASYR1('MOLECULES',SUMM1,LOGMOL,ISTRA,0,NMOL,0,NSTRA,
     .               TEXTS(NSPA+1))
        CALL
     .  EIRENE_MASYR1('ST.DEV.% ',VARM1,LGVRM1,ISTRA,0,NMOL,0,NSTRA,
     .               TEXTS(NSPA+1))
...
C  SURFACE AVERAGED TALLY NO. 53
        CALL
     .  EIRENE_MASYR1('TEST IONS',SUMI1,LOGION,ISTRA,0,NION,0,NSTRA,
     .               TEXTS(NSPAM+1))
        CALL
     .  EIRENE_MASYR1('ST.DEV.% ',VARI1,LGVRI1,ISTRA,0,NION,0,NSTRA,
     .               TEXTS(NSPAM+1))
...
C  SURFACE AVERAGED TALLY NO. 54
        CALL
     .  EIRENE_MASYR1('PHOTONS',SUMPH1,LOGPHOT,ISTRA,0,NPHOT,0,NSTRA,
     .               TEXTS(0+1))
        CALL
     .  EIRENE_MASYR1('ST.DEV.% ',VARPH1,LGVRPH1,ISTRA,0,NPHOT,0,NSTRA,
     .               TEXTS(0+1))
...
C  SURFACE AVERAGED TALLY NO. 55
        CALL
     .  EIRENE_MASYR1('BULK IONS',SUMP1,LOGPLS,ISTRA,0,NPLS,0,NSTRA,
     .               TEXTS(NSPAMI+1))
        CALL
     .  EIRENE_MASYR1('ST.DEV.% ',VARP1,LGVRP1,ISTRA,0,NPLS,0,NSTRA,
     .               TEXTS(NSPAMI+1))
