...
! DATA FOR PHOTONIC LINE
     ...
     .               RP%LINE%IMESS
          WRITE (13) RP%LINE%REACNAME, RP%LINE%KENN
...
! ADAS DATA
     ...
     .            REACDAT(IR)%NOSEC
        ...
        IF (REACDAT(IR)%LRTCMW) CALL
     .  EIRENE_READ_FIT_FORM(REACDAT(IR)%RTCMW)
        IF (REACDAT(IR)%LRTCEW) CALL
     .  EIRENE_READ_FIT_FORM(REACDAT(IR)%RTCEW)
...
! DATA FOR PHOTONIC LINE
     ...
     .              RP%LINE%IFREMD, RP%LINE%NRJPRT, RP%LINE%IPLSC6,
     .              RP%LINE%IMESS
          READ (13) RP%LINE%REACNAME, RP%LINE%KENN
...
! ADAS DATA
     ...
     .            ' ZERO FIT COEFFICIENTS'
            WRITE (iunout,*) 'J,IR = ',J,IR,'  EXIT CALLED!EIRENE_'
