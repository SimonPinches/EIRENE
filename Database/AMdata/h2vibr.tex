...
\usepackage[hypertex,unicode=true,
 ...
 {hyperref}
\hypersetup{pdftitle={AMJUEL Documentation},linkcolor=black,
...
\item{a=2}: ion conversion $p+H_2(v) \rightarrow H_2^+  +  H$
     ...
     the data given here are evaluated from HYDHEL, H.3 3.2.3, at $E_{H_2}=0.37\approx 0.0$. The temperature scale here
     is $T=T_{H_2} = T_p$, i.e. the HYDHEL H.3 fit is evaluated at 
