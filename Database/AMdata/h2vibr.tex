...
\usepackage[hypertex,unicode=true,
 ...
 {hyperref}
\hypersetup{pdftitle={H2vibr Documentation},linkcolor=black,
citecolor=black, urlcolor=blue, filecolor=blue}
...
\usepackage{color}
\pagecolor{white} \setcounter{secnumdepth}{3}
\usepackage{times}
%CSW that's it...
\begin{document}
\parindent 0pt
...
Additional  Molecular Data for EIRENE: vibrationally resolved H$2$
\vspace*{3truecm}
...
Below the following line do not use H.1,....H.12, because EIRENE searches for theses section headers
from here on.
...
now: loss from vibrational state $v$: loss channel $a=1, a=2, a=3$. Notation: ..2.vla,
\begin{itemize}
...
\item{a=2}: ion conversion $p+H_2(v) \rightarrow H_2^+  +  H$
     ...
     the data given here are evaluated from HYDHEL, 3.2.3, at $E_{H_2}=0.37\approx 0.0$. The temperature scale here
     is $T=T_{H_2} = T_p$, i.e. the HYDHEL beam-maxwellian rate fit is evaluated at

     $T_{eff}= m/m_1 T_1 + m/m_2 T_2 = 1.5 T$, with $m=1, m_1=1, m_2=2$
     and $T_1=T_p, T_2=T_{H_2}$.

\item{a=3}: dissociative attachment to $e + H_2(v) \rightarrow H_2^- \rightarrow H(n) + H^-$,
...
\subsection{
Reaction 2.0l1
$ e + H_2(v=0) \rightarrow b_{triplet}\rightarrow e +  H + H $ (Greenland)
}
...
\subsection{
Reaction 2.0l1T
$ e +  H_2(v=0) \rightarrow b_{triplet}\rightarrow e + H + H $ (Tennyson)
}
...
\subsection{
Reaction 2.0l3
 $ e + H_2(v=0) \rightarrow e + H_2^- \rightarrow e + H + H^-$
}
...
\subsection{
Reaction 2.1l1
$ e + H_2(v=1) \rightarrow e + b_{triplet}\rightarrow e + H + H $ (Greenland)
}
...
\subsection{
Reaction 2.1l1T
$ e +  H_2(v=1) \rightarrow e + b_{triplet}\rightarrow e + H + H $ (Tennyson)
}
...
\subsection{
Reaction 2.1l3
 $ e + H_2(v=2) \rightarrow e + H_2^- \rightarrow e + H + H^-$
}
...
\subsection{
Reaction 2.2l1
$ e + H_2(v=2) \rightarrow e + b_{triplet}\rightarrow e + H + H $ (Greenland)
}
...
\subsection{
Reaction 2.2l1T
$ e +  H_2(v=2) \rightarrow e + b_{triplet}\rightarrow e + H + H $ (Tennyson)
}
...
\subsection{
Reaction 2.3l1
$ e + H_2(v=3) \rightarrow e + b_{triplet}\rightarrow e + H + H $ (Greenland)
}
...
\subsection{
Reaction 2.3l1T
$  e + H_2(v=3) \rightarrow e + b_{triplet}\rightarrow e + H + H $ (Tennyson)
}
...
\subsection{
Reaction 2.3l3
 $ e + H_2(v=3) \rightarrow e + H_2^- \rightarrow e + H + H^-$
}
...
\subsection{
Reaction 2.4l1
$ e + H_2(v=4) \rightarrow e + b_{triplet}\rightarrow e + H + H $ (Greenland)
}
...
\subsection{
Reaction 2.4l1T
$  e + H_2(v=4) \rightarrow e + b_{triplet}\rightarrow e + H + H $ (Tennyson)
}
...
\subsection{
Reaction 2.4l3
 $ e + H_2(v=4) \rightarrow e + H_2^- \rightarrow e + H + H^-$
}
...
\subsection{
Reaction 2.5l1
$ e + H_2(v=5) \rightarrow e + b_{triplet}\rightarrow e + H + H $ (Greenland)
}
...
\subsection{
Reaction 2.5l1T
$  e + H_2(v=5) \rightarrow e + b_{triplet}\rightarrow e + H + H $ (Tennyson)
}
...
\subsection{
Reaction 2.5l3
 $ e + H_2(v=5) \rightarrow e + H_2^- \rightarrow e + H + H^-$
}
...
\subsection{
Reaction 2.6l1
$ e + H_2(v=6) \rightarrow e + b_{triplet}\rightarrow e + H + H $ (Greenland)
}
...
\subsection{
Reaction 2.6l1T
$  e + H_2(v=6) \rightarrow e + b_{triplet}\rightarrow e + H + H $ (Tennyson)
}
...
\subsection{
Reaction 2.6l3
 $ e + H_2(v=6) \rightarrow e + H_2^- \rightarrow e + H + H^-$
}
...
\subsection{
Reaction 2.7l1
$ e + H_2(v=7) \rightarrow e + b_{triplet}\rightarrow e + H + H $ (Greenland)
}
...
\subsection{
Reaction 2.7l1T
$ e +  H_2(v=7) \rightarrow e + b_{triplet}\rightarrow e + H + H $ (Tennyson)
}
...
\subsection{
Reaction 2.7l3
 $ e + H_2(v=7) \rightarrow e + H_2^- \rightarrow e + H + H^-$
}
...
\subsection{
Reaction 2.8l1
$ e + H_2(v=8) \rightarrow e + b_{triplet}\rightarrow e +  H + H $ (Greenland)
}
...
\subsection{
Reaction 2.8l1T
$ e +  H_2(v=8) \rightarrow e + b_{triplet}\rightarrow e + H + H $ (Tennyson)
}
...
\subsection{
Reaction 2.8l3
 $ e + H_2(v=8) \rightarrow e + H_2^- \rightarrow e + H + H^-$
}
...
\subsection{
Reaction 2.9l1
$ e + H_2(v=9) \rightarrow e + b_{triplet}\rightarrow e + H + H $ (Greenland)
}
...
\subsection{
Reaction 2.9l1T
$ e +  H_2(v=9) \rightarrow e + b_{triplet}\rightarrow e + H + H $ (Tennyson)
}
...
\subsection{
Reaction 2.9l3
 $ e + H_2(v=9) \rightarrow e + H_2^- \rightarrow e + H + H^-$
}
...
\subsection{
Reaction 2.10l1
$ e + H_2(v=10) \rightarrow e + b_{triplet}\rightarrow e + H + H $ (Greenland)
}
...
\subsection{
Reaction 2.10l1T
$ e +  H_2(v=10) \rightarrow e + b_{triplet}\rightarrow e + H + H $ (Tennyson)
}
...
\subsection{
Reaction 2.10l3
 $ e + H_2(v=10) \rightarrow e + H_2^- \rightarrow e + H + H^-$
}
...
\subsection{
Reaction 2.11l1
$ e + H_2(v=11) \rightarrow e + b_{triplet}\rightarrow e + H + H $ (Greenland)
}
...
\subsection{
Reaction 2.11l1T
$  e + H_2(v=11) \rightarrow e + b_{triplet}\rightarrow e + H + H $ (Tennyson)
}
...
\subsection{
Reaction 2.11l3
 $ e + H_2(v=11) \rightarrow e + H_2^- \rightarrow e + H + H^-$
}
...
\subsection{
Reaction 2.12l1
$ e + H_2(v=12) \rightarrow e + b_{triplet}\rightarrow e + H + H $ (Greenland)
}
...
\subsection{
Reaction 2.12l1T
$  e + H_2(v=12) \rightarrow e + b_{triplet}\rightarrow e + H + H $ (Tennyson)
}
...
\subsection{
Reaction 2.12l3
 $ e + H_2(v=12) \rightarrow e + H_2^- \rightarrow e + H + H^-$
}
...
\subsection{
Reaction 2.13l1
$ e + H_2(v=13) \rightarrow e + b_{triplet}\rightarrow e + H + H $ (Greenland)
}
...
\subsection{
Reaction 2.13l1T
$ e +  H_2(v=13) \rightarrow e + b_{triplet}\rightarrow e + H + H $ (Tennyson)
}
...
\subsection{
Reaction 2.13l3
 $ e + H_2(v=13) \rightarrow e + H_2^- \rightarrow e + H + H^-$
}
...
\subsection{
Reaction 2.14l1
$ e + H_2(v=14) \rightarrow e + b_{triplet}\rightarrow e + H + H $ (Greenland)
}
...
\subsection{
Reaction 2.14l1T
$ e +  H_2(v=14) \rightarrow e + b_{triplet}\rightarrow e + H + H $ (Tennyson)
}
...
\subsection{
Reaction 2.14l3
 $ e + H_2(v=14) \rightarrow e + H_2^- \rightarrow e + H + H^-$
}
