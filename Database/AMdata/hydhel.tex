...
\usepackage[hypertex,unicode=true,
 ...
 {hyperref}
\hypersetup{pdftitle={HYDHEL Documentation},linkcolor=black, citecolor=black, urlcolor=blue, filecolor=blue}
\usepackage{epsf}
...
a factor 10 too large. The fitting coefficients for  cross section and rate coefficient are correct.
...
into the \emph{nl} states of H. Added in Jan. 2014:  polynomial fitting of these rate coefficients, for recombination into
...
\newpage
\subsection{
Reaction 2.3.12 $e + He(1snl|^{2S+1}L) \rightarrow e + He^+(nl)+e$}
...
\newpage
\subsection{
Reaction 2.3.13 $  e + He^+(1s) \rightarrow He(1snl|^{2S+1}L) + h\nu$}
...
\begin{small}\begin{verbatim}
  ...
  al0 -3.294589600000D+01   al1 -1.713112000000D-01   al2  0.000000000000e+00
...
\newpage
\section{H.2  POLYNOMIAL FITS FOR $<\sigma v>$ FOR FIXED $E$:  ELECTRON REACTIONS}
...
Formula: see original text. Here:  fit to rate for recomb into 1s ground state
...
\subsection{
Reaction 2.1.8a $  e + H^+ \rightarrow H(2s) + h\nu $}
Formula: see original text. Here:  added fit to rate for recomb into 2s excited state
...
\subsection{
Reaction 2.1.8b $  e + H^+ \rightarrow H(2p) + h\nu $}
Formula: see original text. Here:  added fit to rate for recomb into 2p excited state
