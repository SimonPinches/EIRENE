...
This database has been superseeded by the later ``Janev-Reiter'' cross section database \cite{kn:JR-2002}, but is kept here 
...
\subsubsection{ Reaction 2.1\mbox{\_new} $e + CH_4 \rightarrow CH_4^+
+ 2e$ }

Fit redone on digitalized data from
report
\begin{small}\begin{verbatim}
   fit-flag 0
