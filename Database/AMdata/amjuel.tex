...
(i.e. H.8 2.1.5G out).
 ...
 \item update    8.9/97 \\
  ...
  H.1 3.1.8SM new (Schultz momentum transfer cross section) \\
  H.1 3.1.8       (Janev total cx cross section)\\
  H.1 3.1.8JM new (Janev total cx cross section *2 = mom trans. x-section)\\
  H.1 3.1.8ST2 new (Schultz total cx cross section *2 = mom trans. x-section)\\
  note: 3.1.8SM $\approx$ 2  * 3.1.8ST within line-thickness
 \item update   23.9/97 \\
