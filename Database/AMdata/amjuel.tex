...
(i.e. H.8 2.1.5G out).
 ...
 \item update    8.9/97 \\
  ...
  H.1 3.1.8S new (Schultz total cx cross section) \\
  H.1 3.1.8M new (Schultz momentum transfer cross section) \\
  H.1 3.1.8D new (Janev total cx cross section *2 = mom trans. x-section)\\
  H.1 3.1.8T new (Schultz total cx cross section *2 = mom trans. x-section)\\
...
\item Oct 15:\\
 started to add TEMIN, TEMAX, NEMIN, NEMAX parameters for extrapolation beyond fit range.
...
process, and also for other (probably mostly recombination) processes, e.g. 2.1.8, 2.2.15, 2.3.13, 2.7.14....
\end{itemize}
...
\end{equation}
with ${\bf v}_0', \mu, \theta$ being the post collision test particle velocity, the reduced mass and the scattering angle in the center of mass frame, respectively.
...
\end{equation}
where $\widetilde{{\bf v}}_0$ is the test particle velocity in the rest frame of the plasma and  $\widetilde{E}_0$ its the corresponding energy, Eq. (\ref{E0rest}).
...
Improved from original Janev-Langer fit at low energies by asymptotic fit.
...
\begin{small}\begin{verbatim}
   ...
   a3  9.205482406462e-03    a4  2.400266568315e-03    a5 -1.927122311323e-03
   a6  3.654750340106e-04    a7 -2.788866460622e-05    a8  7.422296363524e-07
  al0 -3.155960160000e+01   al1 -1.713112000000e-01   al2  0.000000000000e+00
ELABMIN=   0.10000E 00 eV
       Eth  0.0
\end{verbatim}\end{small}
\subsubsection{
...
\subsubsection{
Reaction 3.1.8SM $  p + H(1s) \rightarrow H(1s) + p  $
}
D.Schultz cross section for momentum exchange (elastic plus cx)
fitted into ``Janev format". Should be close to total cx cross section times 2.
