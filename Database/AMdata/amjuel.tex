...
\item Mar. 18: \\
H.12  2.2.5fu, redone. Also: 2.2.5we and 2.2.5ly added (upper werner and lyman band states pop. coef)
\end{itemize}
...
upper Fulcher population coefficient. Triplet d-state, A$_{Fulch} \approx $ 2.53E7
...
upper Werner band population coefficient. Singlet C-state, A$_{Werner} \approx $ 1.18E9
...
upper Lyman band population coefficient. Singlet B-state, A$_{Lyman} \approx $1.18E9
