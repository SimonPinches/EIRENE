...
\item May 16:  H.2 2.2.17s,  H.4 2.2.17r and H.4 2.2.17d: effective, H- condensed, DIS, MAR, MAD rate coefficients for H2, via H2-.
\item June 16:  H.4 2.1.5 and H.10 2.1.5 CR electron impact ionisation: fit range extended from 1e3 to 2e4 eV, new fits and figures
\end{itemize}
...
the collision (i.e., elastic, or resonant charge exchange).
...
(redone May 2016: extend Te range of fit validity from 0.1 -- 1e3 to 0.1 -- 2e4 eV)
